<?php
  class Menu {
    ...
    public function retornaMenuAcessibilidade($pagina, $atual) {
      ...
      echo "      <a href=\"javascript:;\" onClick=\"mudaTamanho('d');\" onKeyPress=\"if (event.keyCode == 13 || event.which == 13 || event.type == \"click\"){mudaTamanho('d');}\"><img src=\"".$_SESSION['life_link_completo']."icones/fonte_diminuir.png\" alt=\"Diminuir tamanho da letra\" title=\"Diminuir tamanho da letra\" border=\"0\"></a>\n";
      echo "      <a href=\"javascript:;\" onClick=\"mudaTamanho('p');\" onKeyPress=\"if (event.keyCode == 13 || event.which == 13 || event.type == \"click\"){mudaTamanho('p');}\"><img src=\"".$_SESSION['life_link_completo']."icones/fonte_normal.png\" alt=\"Deixar a letra no tamanho padrão\" title=\"Deixar a letra no tamanho padrão\" border=\"0\"></a>\n";
      echo "      <a href=\"javascript:;\" onClick=\"mudaTamanho('a');\" onKeyPress=\"if (event.keyCode == 13 || event.which == 13 || event.type == \"click\"){mudaTamanho('a');}\"><img src=\"".$_SESSION['life_link_completo']."icones/fonte_aumentar.png\" alt=\"Aumentar tamanho da letra\" title=\"Aumentar tamanho da letra\" border=\"0\"></a>\n";
    }
