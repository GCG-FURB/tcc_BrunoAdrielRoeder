...
class Configuracao
{
    ...
    private function montarFormularioConfiguracaoPadraoObaa()
    {
        ...
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        $este_elemento[] = $elemento;
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = '';
        $elemento[] = '';
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações gerais';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_general_identifier_cadastro_basico';
        $elemento[] = 'eh_informar_general_identifier_cadastro_requisitar';
        $elemento[] = 'cp_general_identifier_descricao';
        $elemento[] = 'cp_general_identifier_nome';
        $elemento[] = 'cp_general_identifier_informacao';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_general_title_cadastro_basico';
        $elemento[] = 'eh_informar_general_title_cadastro_requisitar';
        $elemento[] = 'cp_general_title_descricao';
        $elemento[] = 'cp_general_title_nome';
        $elemento[] = 'cp_general_title_informacao';
        $elemento[] = 'eh_apresentar_general_title_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Título';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_general_imagem_cadastro_basico';
        $elemento[] = 'eh_informar_general_imagem_cadastro_requisitar';
        $elemento[] = 'cp_general_imagem_descricao';
        $elemento[] = 'cp_general_imagem_nome';
        $elemento[] = 'cp_general_imagem_informacao';
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Imagem';
        $comentario = '';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_general_language_cadastro_basico';
        $elemento[] = 'eh_informar_general_language_cadastro_requisitar';
        $elemento[] = 'cp_general_language_descricao';
        $elemento[] = 'cp_general_language_nome';
        $elemento[] = 'cp_general_language_informacao';
        $elemento[] = 'eh_apresentar_general_language_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Idioma';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_general_description_cadastro_basico';
        $elemento[] = 'eh_informar_general_description_cadastro_requisitar';
        $elemento[] = 'cp_general_description_descricao';
        $elemento[] = 'cp_general_description_nome';
        $elemento[] = 'cp_general_description_informacao';
        $elemento[] = 'eh_apresentar_general_description_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Descrição';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_general_keyword_cadastro_basico';
        $elemento[] = 'eh_informar_general_keyword_cadastro_requisitar';
        $elemento[] = 'cp_general_keyword_descricao';
        $elemento[] = 'cp_general_keyword_nome';
        $elemento[] = 'cp_general_keyword_informacao';
        $elemento[] = 'eh_apresentar_general_keyword_retorno_pesquisa';
        $elemento[] = '';
        ...
        $elemento[] = '';
        $elemento[] = '';
        $elemento[] = 'cp_general_nivel_educacional_descricao';
        $elemento[] = 'cp_general_nivel_educacional_nome';
        $elemento[] = 'cp_general_nivel_educacional_informacao';
        $elemento[] = 'eh_apresentar_general_nivel_educacional_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Nível educacional';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_general_coverage_cadastro_basico';
        $elemento[] = 'eh_informar_general_coverage_cadastro_requisitar';
        $elemento[] = 'cp_general_coverage_descricao';
        $elemento[] = 'cp_general_coverage_nome';
        $elemento[] = 'cp_general_coverage_informacao';
        $elemento[] = '';
        $elemento[] = '';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_general_structure_cadastro_basico';
        $elemento[] = 'eh_informar_general_structure_cadastro_requisitar';
        $elemento[] = 'cp_general_structure_descricao';
        $elemento[] = 'cp_general_structure_nome';
        $elemento[] = 'cp_general_structure_informacao';
        $elemento[] = 'eh_apresentar_general_structure_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Estrutura';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_general_agregation_level_cadastro_basico';
        $elemento[] = 'eh_informar_general_agregation_level_cadastro_requisitar';
        $elemento[] = 'cp_general_agregation_level_descricao';
        $elemento[] = 'cp_general_agregation_level_nome';
        $elemento[] = 'cp_general_agregation_level_informacao';
        $elemento[] = 'eh_apresentar_general_agregation_level_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Nível de agregação';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações sobre ciclo de vida';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_lyfe_cycle_version_cadastro_basico';
        $elemento[] = 'eh_informar_lyfe_cycle_version_cadastro_requisitar';
        $elemento[] = 'cp_lyfe_cycle_version_descricao';
        $elemento[] = 'cp_lyfe_cycle_version_nome';
        $elemento[] = 'cp_lyfe_cycle_version_informacao';
        $elemento[] = 'eh_apresentar_lyfe_cycle_version_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Versão';
        $comentario = '';
        $este_elemento = array();
      ...
      //$elemento = array();       $elemento[] = 'eh_informar_lyfe_cycle_status_cadastro_basico';       $elemento[] = 'eh_informar_lyfe_cycle_status_cadastro_requisitar';       $elemento[] = 'cp_lyfe_cycle_status_descricao';       $elemento[] = 'cp_lyfe_cycle_status_nome';       $elemento[] = 'cp_lyfe_cycle_status_informacao';       $elemento[] = 'eh_apresentar_lyfe_cycle_status_retorno_pesquisa';       $elemento[] = '';        $titulo = 'Status';        $comentario = '';      $este_elemento = array();         $este_elemento[] = $titulo;         $este_elemento[] = $comentario;          $este_elemento[] = $elemento;    $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_lyfe_cycle_contribute_cadastro_basico';
        $elemento[] = 'eh_informar_lyfe_cycle_contribute_cadastro_requisitar';
        $elemento[] = 'cp_lyfe_cycle_contribute_descricao';
        $elemento[] = 'cp_lyfe_cycle_contribute_nome';
        $elemento[] = 'cp_lyfe_cycle_contribute_informacao';
        $elemento[] = 'eh_apresentar_lyfe_cycle_contribute_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Contribuição';
        $comentario = '';
        $este_elemento = array();
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações de meta-metadata';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_meta_metadata_identifier_cadastro_basico';
        $elemento[] = 'eh_informar_meta_metadata_identifier_cadastro_requisitar';
        $elemento[] = 'cp_meta_metadata_identifier_descricao';
        $elemento[] = 'cp_meta_metadata_identifier_nome';
        $elemento[] = 'cp_meta_metadata_identifier_informacao';
        $elemento[] = 'eh_apresentar_meta_metadata_identifier_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Identificador';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_meta_metadata_contribute_cadastro_basico';
        $elemento[] = 'eh_informar_meta_metadata_contribute_cadastro_requisitar';
        $elemento[] = 'cp_meta_metadata_contribute_descricao';
        $elemento[] = 'cp_meta_metadata_contribute_nome';
        $elemento[] = 'cp_meta_metadata_contribute_informacao';
        $elemento[] = 'eh_apresentar_meta_metadata_contribute_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Contribuição';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_meta_metadata_metadata_schema_cadastro_basico';
        $elemento[] = 'eh_informar_meta_metadata_metadata_schema_cadastro_requisitar';
        $elemento[] = 'cp_meta_metadata_metadata_schema_descricao';
        $elemento[] = 'cp_meta_metadata_metadata_schema_nome';
        $elemento[] = 'cp_meta_metadata_metadata_schema_informacao';
        $elemento[] = 'eh_apresentar_meta_metadata_metadata_schema_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Esquema de metadados';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_meta_metadata_language_cadastro_basico';
        $elemento[] = 'eh_informar_meta_metadata_language_cadastro_requisitar';
        $elemento[] = 'cp_meta_metadata_language_descricao';
        $elemento[] = 'cp_meta_metadata_language_nome';
        $elemento[] = 'cp_meta_metadata_language_informacao';
        $elemento[] = 'eh_apresentar_meta_metadata_language_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Idioma';
        $comentario = '';
        $este_elemento = array();
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações Técnicas';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_format_cadastro_basico';
        $elemento[] = 'eh_informar_technical_format_cadastro_requisitar';
        $elemento[] = 'cp_technical_format_descricao';
        $elemento[] = 'cp_technical_format_nome';
        $elemento[] = 'cp_technical_format_informacao';
        $elemento[] = 'eh_apresentar_technical_format_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Formato';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_size_cadastro_basico';
        $elemento[] = 'eh_informar_technical_size_cadastro_requisitar';
        $elemento[] = 'cp_technical_size_descricao';
        $elemento[] = 'cp_technical_size_nome';
        $elemento[] = 'cp_technical_size_informacao';
        $elemento[] = 'eh_apresentar_technical_size_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Tamanho';
        $comentario = '';
        $este_elemento = array();
        ...
        $elemento[] = '';
        $elemento[] = '';
        $elemento[] = 'cp_technical_location_descricao';
        $elemento[] = 'cp_technical_location_nome';
        $elemento[] = 'cp_technical_location_informacao';
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Localização';
        $comentario = '';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_requirement_cadastro_basico';
        $elemento[] = 'eh_informar_technical_requirement_cadastro_requisitar';
        $elemento[] = 'cp_technical_requirement_descricao';
        $elemento[] = 'cp_technical_requirement_nome';
        $elemento[] = 'cp_technical_requirement_informacao';
        $elemento[] = 'eh_apresentar_technical_requirement_retorno_pesquisa';
        $elemento[] = '';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_composite_cadastro_basico';
        $elemento[] = 'eh_informar_technical_composite_cadastro_requisitar';
        $elemento[] = 'cp_technical_composite_descricao';
        $elemento[] = 'cp_technical_composite_nome';
        $elemento[] = 'cp_technical_composite_informacao';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_installation_remarks_cadastro_basico';
        $elemento[] = 'eh_informar_technical_installation_remarks_cadastro_requisitar';
        $elemento[] = 'cp_technical_installation_remarks_descricao';
        $elemento[] = 'cp_technical_installation_remarks_nome';
        $elemento[] = 'cp_technical_installation_remarks_informacao';
        $elemento[] = 'eh_apresentar_technical_installation_remarks_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Observações de instalação';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_other_plataforms_requirements_cadastro_basico';
        $elemento[] = 'eh_informar_technical_other_plataforms_requirements_cadastro_requisitar';
        $elemento[] = 'cp_technical_other_plataforms_requirements_descricao';
        $elemento[] = 'cp_technical_other_plataforms_requirements_nome';
        $elemento[] = 'cp_technical_other_plataforms_requirements_informacao';
        $elemento[] = 'eh_apresentar_technical_other_plataforms_requirements_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Outras plataformas Requisitos';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_duration_cadastro_basico';
        $elemento[] = 'eh_informar_technical_duration_cadastro_requisitar';
        $elemento[] = 'cp_technical_duration_descricao';
        $elemento[] = 'cp_technical_duration_nome';
        $elemento[] = 'cp_technical_duration_informacao';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_supported_plataform_cadastro_basico';
        $elemento[] = 'eh_informar_technical_supported_plataform_cadastro_requisitar';
        $elemento[] = 'cp_technical_supported_plataform_descricao';
        $elemento[] = 'cp_technical_supported_plataform_nome';
        $elemento[] = 'cp_technical_supported_plataform_informacao';
        $elemento[] = 'eh_apresentar_technical_supported_plataform_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Plataforma';
        $comentario = '';
        $este_elemento = array();
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Características referentes as Informações técnicas';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_plataform_specific_features_plataform_type_cadastro_basico';
        $elemento[] = 'eh_informar_technical_plataform_specific_features_plataform_type_cadastro_requisitar';
        $elemento[] = 'cp_technical_plataform_specific_features_plataform_type_descricao';
        $elemento[] = 'cp_technical_plataform_specific_features_plataform_type_nome';
        $elemento[] = 'cp_technical_plataform_specific_features_plataform_type_informacao';
        $elemento[] = 'eh_apresentar_technical_plataform_specific_features_plataform_type_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Tipo de Plataforma';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_format_cadastro_basico';
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_format_cadastro_requisitar';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_format_descricao';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_format_nome';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_format_informacao';
        $elemento[] = 'eh_apresentar_technical_plataform_specific_features_specific_format_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Formato';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_size_cadastro_basico';
        ...
        $elemento[] = 'cp_technical_plataform_specific_features_specific_size_nome';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_size_informacao';
        $elemento[] = 'eh_apresentar_technical_plataform_specific_features_specific_size_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Tamanho';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_location_cadastro_basico';
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_location_cadastro_requisitar';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_location_descricao';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_location_nome';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_location_informacao';
        $elemento[] = 'eh_apresentar_technical_plataform_specific_features_specific_location_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Localização';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_requeriments_cadastro_basico';
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_requeriments_cadastro_requisitar';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_requeriments_descricao';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_requeriments_nome';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_requeriments_informacao';
        $elemento[] = 'eh_apresentar_technical_plataform_specific_features_specific_requeriments_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Requerimentos';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_instalation_remarks_cadastro_basico';
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_instalation_remarks_cadastro_intermediari';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_instalation_remarks_descricao';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_instalation_remarks_nome';
        $elemento[] = 'cp_technical_plataform_specific_features_specific_instalation_remarks_informacao';
        $elemento[] = 'eh_apresentar_technical_plataform_specific_features_specific_instalation_remarks_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Observações de instalação';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_other_plataform_requeriments_cadastro_bas';
        $elemento[] = 'eh_informar_technical_plataform_specific_features_specific_other_plataform_requeriments_cadastro_int';
        ...
        $elemento[] = '';
        $titulo = 'Outros requerimentos da plataforma';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Serviços referentes as informações técnicas';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_service_name_cadastro_basico';
        $elemento[] = 'eh_informar_technical_service_name_cadastro_requisitar';
        $elemento[] = 'cp_technical_service_name_descricao';
        $elemento[] = 'cp_technical_service_name_nome';
        $elemento[] = 'cp_technical_service_name_informacao';
        $elemento[] = 'eh_apresentar_technical_service_name_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Nome';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_service_type_cadastro_basico';
        $elemento[] = 'eh_informar_technical_service_type_cadastro_requisitar';
        $elemento[] = 'cp_technical_service_type_descricao';
        $elemento[] = 'cp_technical_service_type_nome';
        $elemento[] = 'cp_technical_service_type_informacao';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_service_provides_cadastro_basico';
        $elemento[] = 'eh_informar_technical_service_provides_cadastro_requisitar';
        $elemento[] = 'cp_technical_service_provides_descricao';
        $elemento[] = 'cp_technical_service_provides_nome';
        $elemento[] = 'cp_technical_service_provides_informacao';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_service_essential_cadastro_basico';
        $elemento[] = 'eh_informar_technical_service_essential_cadastro_requisitar';
        $elemento[] = 'cp_technical_service_essential_descricao';
        $elemento[] = 'cp_technical_service_essential_nome';
        $elemento[] = 'cp_technical_service_essential_informacao';
        $elemento[] = 'eh_apresentar_technical_service_essential_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Essencial';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_service_protocol_cadastro_basico';
        $elemento[] = 'eh_informar_technical_service_protocol_cadastro_requisitar';
        $elemento[] = 'cp_technical_service_protocol_descricao';
        $elemento[] = 'cp_technical_service_protocol_nome';
        $elemento[] = 'cp_technical_service_protocol_informacao';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_service_ontology_cadastro_basico';
        $elemento[] = 'eh_informar_technical_service_ontology_cadastro_requisitar';
        $elemento[] = 'cp_technical_service_ontology_descricao';
        $elemento[] = 'cp_technical_service_ontology_nome';
        $elemento[] = 'cp_technical_service_ontology_informacao';
        $elemento[] = 'eh_apresentar_technical_service_ontology_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Ontologia';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_service_language_cadastro_basico';
        $elemento[] = 'eh_informar_technical_service_language_cadastro_requisitar';
        $elemento[] = 'cp_technical_service_language_descricao';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_technical_service_details_cadastro_basico';
        $elemento[] = 'eh_informar_technical_service_details_cadastro_requisitar';
        $elemento[] = 'cp_technical_service_details_descricao';
        $elemento[] = 'cp_technical_service_details_nome';
        $elemento[] = 'cp_technical_service_details_informacao';
        $elemento[] = 'eh_apresentar_technical_service_details_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Detalhes';
        $comentario = '';
        $este_elemento = array();
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações educacionais';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_interactivity_type_cadastro_basico';
        $elemento[] = 'eh_informar_educational_interactivity_type_cadastro_requisitar';
        $elemento[] = 'cp_educational_interactivity_type_descricao';
        $elemento[] = 'cp_educational_interactivity_type_nome';
        $elemento[] = 'cp_educational_interactivity_type_informacao';
        $elemento[] = 'eh_apresentar_educational_interactivity_type_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Tipo de interatividade';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_learning_resource_type_cadastro_basico';
        $elemento[] = 'eh_informar_educational_learning_resource_type_cadastro_requisitar';
        $elemento[] = 'cp_educational_learning_resource_type_descricao';
        $elemento[] = 'cp_educational_learning_resource_type_nome';
        $elemento[] = 'cp_educational_learning_resource_type_informacao';
        $elemento[] = 'eh_apresentar_educational_learning_resource_type_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Recursos de aprendizagem';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_interactivity_level_cadastro_basico';
        $elemento[] = 'eh_informar_educational_interactivity_level_cadastro_requisitar';
        $elemento[] = 'cp_educational_interactivity_level_descricao';
        $elemento[] = 'cp_educational_interactivity_level_nome';
        $elemento[] = 'cp_educational_interactivity_level_informacao';
        $elemento[] = 'eh_apresentar_educational_interactivity_level_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Nível de interatividade';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_sem_antic_density_cadastro_basico';
        $elemento[] = 'eh_informar_educational_sem_antic_density_cadastro_requisitar';
        $elemento[] = 'cp_educational_sem_antic_density_descricao';
        $elemento[] = 'cp_educational_sem_antic_density_nome';
        $elemento[] = 'cp_educational_sem_antic_density_informacao';
        $elemento[] = 'eh_apresentar_educational_sem_antic_density_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Densidade';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_intended_end_user_role_cadastro_basico';
        $elemento[] = 'eh_informar_educational_intended_end_user_role_cadastro_requisitar';
        $elemento[] = 'cp_educational_intended_end_user_role_descricao';
        $elemento[] = 'cp_educational_intended_end_user_role_nome';
        $elemento[] = 'cp_educational_intended_end_user_role_informacao';
        $elemento[] = 'eh_apresentar_educational_intended_end_user_role_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Função';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_context_cadastro_basico';
        $elemento[] = 'eh_informar_educational_context_cadastro_requisitar';
        $elemento[] = 'cp_educational_context_descricao';
        $elemento[] = 'cp_educational_context_nome';
        $elemento[] = 'cp_educational_context_informacao';
        $elemento[] = 'eh_apresentar_educational_context_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Contexto';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_typical_age_range_cadastro_basico';
        $elemento[] = 'eh_informar_educational_typical_age_range_cadastro_requisitar';
        $elemento[] = 'cp_educational_typical_age_range_descricao';
        $elemento[] = 'cp_educational_typical_age_range_nome';
        $elemento[] = 'cp_educational_typical_age_range_informacao';
        $elemento[] = 'eh_apresentar_educational_typical_age_range_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Faixa etária';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_difficulty_cadastro_basico';
        $elemento[] = 'eh_informar_educational_difficulty_cadastro_requisitar';
        $elemento[] = 'cp_educational_difficulty_descricao';
        $elemento[] = 'cp_educational_difficulty_nome';
        $elemento[] = 'cp_educational_difficulty_informacao';
        $elemento[] = 'eh_apresentar_educational_difficulty_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Dificuldade';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_typical_learning_time_cadastro_basico';
        $elemento[] = 'eh_informar_educational_typical_learning_time_cadastro_requisitar';
        $elemento[] = 'cp_educational_typical_learning_time_descricao';
        $elemento[] = 'cp_educational_typical_learning_time_nome';
        $elemento[] = 'cp_educational_typical_learning_time_informacao';
        $elemento[] = 'eh_apresentar_educational_typical_learning_time_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Tempo de aprendizagem';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_description_cadastro_basico';
        $elemento[] = 'eh_informar_educational_description_cadastro_requisitar';
        $elemento[] = 'cp_educational_description_descricao';
        $elemento[] = 'cp_educational_description_nome';
        $elemento[] = 'cp_educational_description_informacao';
        $elemento[] = 'eh_apresentar_educational_description_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Descrição';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_language_cadastro_basico';
        $elemento[] = 'eh_informar_educational_language_cadastro_requisitar';
        $elemento[] = 'cp_educational_language_descricao';
        $elemento[] = 'cp_educational_language_nome';
        $elemento[] = 'cp_educational_language_informacao';
        $elemento[] = 'eh_apresentar_educational_language_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Idioma';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_learning_content_type_cadastro_basico';
        $elemento[] = 'eh_informar_educational_learning_content_type_cadastro_requisitar';
        $elemento[] = 'cp_educational_learning_content_type_descricao';
        $elemento[] = 'cp_educational_learning_content_type_nome';
        $elemento[] = 'cp_educational_learning_content_type_informacao';
        $elemento[] = 'eh_apresentar_educational_learning_content_type_retorno_pesquisa';
        $elemento[] = '';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_interaction_cadastro_basico';
        $elemento[] = 'eh_informar_educational_interaction_cadastro_requisitar';
        $elemento[] = 'cp_educational_interaction_descricao';
        $elemento[] = 'cp_educational_interaction_nome';
        $elemento[] = 'cp_educational_interaction_informacao';
        $elemento[] = 'eh_apresentar_educational_interaction_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Interação';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_educational_didatic_strategy_cadastro_basico';
        $elemento[] = 'eh_informar_educational_didatic_strategy_cadastro_requisitar';
        $elemento[] = 'cp_educational_didatic_strategy_descricao';
        $elemento[] = 'cp_educational_didatic_strategy_nome';
        $elemento[] = 'cp_educational_didatic_strategy_informacao';
        $elemento[] = 'eh_apresentar_educational_didatic_strategy_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Estratégia didática';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações de direitos';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_rights_cost_cadastro_basico';
        $elemento[] = 'eh_informar_rights_cost_cadastro_requisitar';
        $elemento[] = 'cp_rights_cost_descricao';
        $elemento[] = 'cp_rights_cost_nome';
        $elemento[] = 'cp_rights_cost_informacao';
        $elemento[] = 'eh_apresentar_rights_cost_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Custo';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_rights_copyright_and_other_restrictions_cadastro_basico';
        $elemento[] = 'eh_informar_rights_copyright_and_other_restrictions_cadastro_requisitar';
        $elemento[] = 'cp_rights_copyright_and_other_restrictions_descricao';
        $elemento[] = 'cp_rights_copyright_and_other_restrictions_nome';
        $elemento[] = 'cp_rights_copyright_and_other_restrictions_informacao';
        $elemento[] = 'eh_apresentar_rights_copyright_and_other_restrictions_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Direitos de autor e outras restrições';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_rights_description_cadastro_basico';
        $elemento[] = 'eh_informar_rights_description_cadastro_requisitar';
        $elemento[] = 'cp_rights_description_descricao';
        $elemento[] = 'cp_rights_description_nome';
        $elemento[] = 'cp_rights_description_informacao';
        $elemento[] = 'eh_apresentar_rights_description_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Descrição';
        $comentario = '';
        $este_elemento = array();
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações sobre relações';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_relation_kind_cadastro_basico';
        $elemento[] = 'eh_informar_relation_kind_cadastro_requisitar';
        $elemento[] = 'cp_relation_kind_descricao';
        $elemento[] = 'cp_relation_kind_nome';
        $elemento[] = 'cp_relation_kind_informacao';
        $elemento[] = 'eh_apresentar_relation_kind_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Tipo';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_relation_resource_cadastro_basico';
        $elemento[] = 'eh_informar_relation_resource_cadastro_requisitar';
        $elemento[] = 'cp_relation_resource_descricao';
        $elemento[] = 'cp_relation_resource_nome';
        $elemento[] = 'cp_relation_resource_informacao';
        $elemento[] = 'eh_apresentar_relation_resource_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Recurso';
        $comentario = '';
        $este_elemento = array();
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações de anotações';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_annotation_entity_cadastro_basico';
        $elemento[] = 'eh_informar_annotation_entity_cadastro_requisitar';
        $elemento[] = 'cp_annotation_entity_descricao';
        $elemento[] = 'cp_annotation_entity_nome';
        $elemento[] = 'cp_annotation_entity_informacao';
        $elemento[] = 'eh_apresentar_annotation_entity_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Entidade';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_annotation_date_cadastro_basico';
        $elemento[] = 'eh_informar_annotation_date_cadastro_requisitar';
        $elemento[] = 'cp_annotation_date_descricao';
        $elemento[] = 'cp_annotation_date_nome';
        $elemento[] = 'cp_annotation_date_informacao';
        $elemento[] = 'eh_apresentar_annotation_date_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Data';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_annotation_description_cadastro_basico';
        $elemento[] = 'eh_informar_annotation_description_cadastro_requisitar';
        $elemento[] = 'cp_annotation_description_descricao';
        $elemento[] = 'cp_annotation_description_nome';
        $elemento[] = 'cp_annotation_description_informacao';
        $elemento[] = 'eh_apresentar_annotation_description_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Descrição';
        $comentario = '';
        $este_elemento = array();
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações sobre classificações';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_classification_purpose_cadastro_basico';
        $elemento[] = 'eh_informar_classification_purpose_cadastro_requisitar';
        $elemento[] = 'cp_classification_purpose_descricao';
        $elemento[] = 'cp_classification_purpose_nome';
        $elemento[] = 'cp_classification_purpose_informacao';
        $elemento[] = 'eh_apresentar_classification_purpose_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Propósito';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_classification_taxon_path_cadastro_basico';
        $elemento[] = 'eh_informar_classification_taxon_path_cadastro_requisitar';
        $elemento[] = 'cp_classification_taxon_path_descricao';
        $elemento[] = 'cp_classification_taxon_path_nome';
        $elemento[] = 'cp_classification_taxon_path_informacao';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_classification_description_cadastro_basico';
        $elemento[] = 'eh_informar_classification_description_cadastro_requisitar';
        $elemento[] = 'cp_classification_description_descricao';
        $elemento[] = 'cp_classification_description_nome';
        $elemento[] = 'cp_classification_description_informacao';
        $elemento[] = 'eh_apresentar_classification_description_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Descrição';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_classification_keyword_cadastro_basico';
        $elemento[] = 'eh_informar_classification_keyword_cadastro_requisitar';
        $elemento[] = 'cp_classification_keyword_descricao';
        $elemento[] = 'cp_classification_keyword_nome';
        $elemento[] = 'cp_classification_keyword_informacao';
        $elemento[] = 'eh_apresentar_classification_keyword_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Palavras-chave';
        $comentario = '';
        $este_elemento = array();
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações sobre acessibilidade';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_acessibility_has_visual_cadastro_basico';
        $elemento[] = 'eh_informar_acessibility_has_visual_cadastro_requisitar';
        $elemento[] = 'cp_acessibility_has_visual_descricao';
        $elemento[] = 'cp_acessibility_has_visual_nome';
        $elemento[] = 'cp_acessibility_has_visual_informacao';
        $elemento[] = 'eh_apresentar_acessibility_has_visual_retorno_pesquisa';
        $elemento[] = '';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_acessibility_has_audititory_cadastro_basico';
        $elemento[] = 'eh_informar_acessibility_has_audititory_cadastro_requisitar';
        $elemento[] = 'cp_acessibility_has_audititory_descricao';
        $elemento[] = 'cp_acessibility_has_audititory_nome';
        $elemento[] = 'cp_acessibility_has_audititory_informacao';
        $elemento[] = 'eh_apresentar_acessibility_has_audititory_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Elementos sonoros';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_acessibility_has_text_cadastro_basico';
        $elemento[] = 'eh_informar_acessibility_has_text_cadastro_requisitar';
        $elemento[] = 'cp_acessibility_has_text_descricao';
        $elemento[] = 'cp_acessibility_has_text_nome';
        $elemento[] = 'cp_acessibility_has_text_informacao';
        $elemento[] = 'eh_apresentar_acessibility_has_text_retorno_pesquisa';
        $elemento[] = '';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_acessibility_has_tactible_cadastro_basico';
        $elemento[] = 'eh_informar_acessibility_has_tactible_cadastro_requisitar';
        $elemento[] = 'cp_acessibility_has_tactible_descricao';
        $elemento[] = 'cp_acessibility_has_tactible_nome';
        $elemento[] = 'cp_acessibility_has_tactible_informacao';
        $elemento[] = 'eh_apresentar_acessibility_has_tactible_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Elementos táteis';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_acessibility_earl_statment_cadastro_basico';
        $elemento[] = 'eh_informar_acessibility_earl_statment_cadastro_requisitar';
        $elemento[] = 'cp_acessibility_earl_statment_descricao';
        $elemento[] = 'cp_acessibility_earl_statment_nome';
        $elemento[] = 'cp_acessibility_earl_statment_informacao';
        $elemento[] = 'eh_apresentar_acessibility_earl_statment_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Declaração';
        $comentario = '';
        $este_elemento = array();
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_acessibility_equivalent_resource_cadastro_basico';
        $elemento[] = 'eh_informar_acessibility_equivalent_resource_cadastro_requisitar';
        $elemento[] = 'cp_acessibility_equivalent_resource_descricao';
        $elemento[] = 'cp_acessibility_equivalent_resource_nome';
        $elemento[] = 'cp_acessibility_equivalent_resource_informacao';
        $elemento[] = 'eh_apresentar_acessibility_equivalent_resource_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Recursos equivalentes';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $elemento[] = '';
        $elemento[] = '';
        $titulo = 'Grupo: Informações do segmento';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_segment_information_table_segment_list_cadastro_basico';
        $elemento[] = 'eh_informar_segment_information_table_segment_list_cadastro_requisitar';
        $elemento[] = 'cp_segment_information_table_segment_list_descricao';
        $elemento[] = 'cp_segment_information_table_segment_list_nome';
        $elemento[] = 'cp_segment_information_table_segment_list_informacao';
        $elemento[] = 'eh_apresentar_segment_information_table_segment_list_retorno_pesquisa';
        $elemento[] = '';
        ...
        $lista[] = $este_elemento;
        $elemento = array();
        $elemento[] = 'eh_informar_segment_information_table_segmente_group_list_cadastro_basico';
        $elemento[] = 'eh_informar_segment_information_table_segmente_group_list_cadastro_requisitar';
        $elemento[] = 'cp_segment_information_table_segmente_group_list_descricao';
        $elemento[] = 'cp_segment_information_table_segmente_group_list_nome';
        $elemento[] = 'cp_segment_information_table_segmente_group_list_informacao';
        $elemento[] = 'eh_apresentar_segment_information_table_segmente_group_list_retorno_pesquisa';
        $elemento[] = '';
        $titulo = 'Lista de grupo de segmento';
        $comentario = '';
        $este_elemento = array();
        $este_elemento[] = $titulo;
        $este_elemento[] = $comentario;
    ...
    public function salvarEdicaoConfiguracoes($secao, $subsecao)
    {
        ...
        if (isset($_POST['quantidade'])) {
            ...
            for ($i=1; $i<$quantidade; $i++) {
                $nome_variavel = 'variavel_'.$i;
                $variavel = addslashes($_POST[$nome_variavel]);
                $tipo_variavel = 'tipo_'.$i;
                $tipo = addslashes($_POST[$tipo_variavel]);
                $campo_plataforma = 'plataforma_'.$i;
                $plataforma = addslashes($_POST[$campo_plataforma]);
          ...
          //$elemento = array();       $elemento[] = 'eh_informar_lyfe_cycle_status_cadastro_basico';       $elemento[] = 'eh_informar_lyfe_cycle_status_cadastro_requisitar';       $elemento[] = 'cp_lyfe_cycle_status_descricao';       $elemento[] = 'cp_lyfe_cycle_status_nome';       $elemento[] = 'cp_lyfe_cycle_status_informacao';       $elemento[] = 'eh_apresentar_lyfe_cycle_status_retorno_pesquisa';       $elemento[] = '';        $titulo = 'Status';        $comentario = '';      $este_elemento = array();         $este_elemento[] = $titulo;         $este_elemento[] = $comentario;          $este_elemento[] = $elemento;    $lista[] = $este_elemento;
            ...
            $elemento = array();
            $elemento[] = '';
            $elemento[] = 'eh_informar_technical_location_cadastro_requisitar';
            $elemento[] = 'cp_technical_location_descricao';
            $elemento[] = 'cp_technical_location_nome';
            $elemento[] = 'cp_technical_location_informacao';
            $elemento[] = '';
...
//***************************CONFIGURADORES*************************************    
    private function configuradorCampoInteiro($variavel, $tamanho, $limite, $indice, $obrigatorio, $plataforma)
    {
        ...
        $tipo = 'vl_inteiro';
        $valor = $dados[$tipo];
        $nome_variavel = 'variavel_'.$indice;
        $util->campoHidden($nome_variavel, $variavel);
        $tipo_variavel = 'tipo_'.$indice;
        $util->campoHidden($tipo_variavel, $tipo);
        $campo_plataforma = 'plataforma_'.$indice;
        $util->campoHidden($campo_plataforma, $plataforma);
...
/*
    ...
    private function configuradorCampoTexto($variavel, $altura, $largura, $indice, $obrigatorio, $plataforma)
    {
        ...
        $util->campoHidden($nome_variavel, $variavel);
        $tipo_variavel = 'tipo_'.$indice;
        $util->campoHidden($tipo_variavel, 'vl_texto');
        $campo_plataforma = 'plataforma_'.$indice;
        $util->campoHidden($campo_plataforma, $plataforma);
