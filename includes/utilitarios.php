...
class Utilitario
{
    ...
    function mudarTamanhoFonte($acao)
    {
        ...
        if ($acao == 'reduzir-tamanho-fonte') {
            $tamanho = $tamanho_atual - 1;
        } elseif ($acao == 'aumentar-tamanho-fonte') {
            $tamanho = $tamanho_atual + 1;
        } elseif ($acao == 'tamanho-fonte-regular') {
            $tamanho = 4;
        }
        if ($tamanho > 8) {
            $tamanho = 8;
...
//******************************************************************************    
    ...
    public function linhaUmCampoArquivo($obrigatorio, $descricao, $nome, $maximo, $tamanho, $valor)
    {
        ...
        echo "        </td>\n";
        echo "  	    <td class=\"celConteudoCampo\">\n";
        echo "          <input type=\"file\" maxlength=\"".$maximo."\" name=\"".$nome."\" id=\"".$nome."\" value=\"".$valor."\" class=\"fontConteudoCampo\" style=\"width:".$tamanho."%;\" tabindex=\"1\" />\n";
        echo "        </td>\n";
        echo "      </tr>\n";
    }
