...
/*
    ...
    public function listarNoticias($acao)
    {
        ...
        if ($_SESSION['life_noticia_pagina'] > 0) {
            echo "      <a href=\"".$_SESSION['life_link_completo']."noticias/primeira\"><img src=\"".$_SESSION['life_link_completo']."icones/navegacao_primeira.png\" alt=\"Primeira Página\" title=\"Primeira Página\" border=\"0\"></a>\n";
        }
        if ($_SESSION['life_noticia_pagina'] > 1) {
            echo "      <a href=\"".$_SESSION['life_link_completo']."noticias/anterior\"><img src=\"".$_SESSION['life_link_completo']."icones/navegacao_anterior.png\" alt=\"Página Anterior\" title=\"Página Anterior\" border=\"0\"></a>\n";
        }
        if ($_SESSION['life_noticia_pagina'] < ($_SESSION['life_noticia_paginas'] - 1)) {
            echo "      <a href=\"".$_SESSION['life_link_completo']."noticias/proxima\"><img src=\"".$_SESSION['life_link_completo']."icones/navegacao_proxima.png\" alt=\"Próxima Página\" title=\"Próxima Página\" border=\"0\"></a>\n";
        }
        if ($_SESSION['life_noticia_pagina'] < $_SESSION['life_noticia_paginas']) {
            echo "      <a href=\"".$_SESSION['life_link_completo']."noticias/ultima\"><img src=\"".$_SESSION['life_link_completo']."icones/navegacao_ultima.png\" alt=\"Última Página\" title=\"Última Página\" border=\"0\"></a>\n";
        }
        echo "    </p>\n";
    }
