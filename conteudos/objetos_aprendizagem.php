<?php
  class ObjetoAprendizagem {
    ...
    public function controleExibicao($secao, $subsecao, $item) {
      ...
      if ($funcao == 'agrupamento') {        $_SESSION['life_c_eh_proprietario'] = '0';      } else {        $_SESSION['life_c_eh_proprietario'] = '1';      }
    ...
    private function listarAcoes($secao, $subsecao, $item, $ativas, $ordem) {
      ...
      $opcoes_1= array();
      $id = 1;
      $opcao= array();      $opcao['indice']= $id;    $id+= 1;      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&od=".$ordem."&at=1";                 if($ativas == '1') { $opcao['selecionado'] = ' selected=\"selected\" '; } else { $opcao['selecionado'] = ''; }              $opcao['descricao']= "Ativos";                                                               $opcoes_1[]= $opcao;
      $opcao= array();      $opcao['indice']= $id;    $id+= 1;      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&od=".$ordem."&at=0";                 if($ativas == '0') { $opcao['selecionado'] = ' selected=\"selected\" '; } else { $opcao['selecionado'] = ''; }              $opcao['descricao']= "Inativos";                                                             $opcoes_1[]= $opcao;
      $opcao= array();      $opcao['indice']= $id;    $id+= 1;      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&od=".$ordem."&at=2";                 if($ativas == '2') { $opcao['selecionado'] = ' selected=\"selected\" '; } else { $opcao['selecionado'] = ''; }              $opcao['descricao']= "Ativos/Inativos";                                                      $opcoes_1[]= $opcao;
...
//***************EXIBICAO PUBLICA***********************************************
    public function retornaConteudoCapaTopo($pagina, $lista_paginas) {
      ...
      if (isset($_SESSION['life_codigo'])) {
        ...
        $campos = array();
        $campo['campo'] = 'language';              $campo['cd_campo'] = '0';                                   $campos[] = $campo;
        $campo['campo'] = 'status';                $campo['cd_campo'] = '0';                                   $campos[] = $campo;
        $campo['campo'] = 'formato';               $campo['cd_campo'] = '0';                                   $campos[] = $campo;
        ...
        if (count($niveis_educacionais_pessoa) > 0) {
          ...
          $campo['campo'] = 'nivel_educacional';     $campo['cd_campo'] = $nivel['cd_nivel_educacional'];        $campos[] = $campo;
        } else {
          $campo['campo'] = 'nivel_educacional';     $campo['cd_campo'] = '0';                                   $campos[] = $campo;
        }
        ...
        $area = $areas_conhecimento_pessoa[rand(0, count($areas_conhecimento_pessoa)-1)];
          $campo['campo'] = 'coverage';              $campo['cd_campo'] = $area['cd_area_conhecimento'];         $campos[] = $campo;
        } else {
          $campo['campo'] = 'coverage';              $campo['cd_campo'] = '0';                                   $campos[] = $campo;
        }
        $_SESSION['life_c_campos_pesquisa'] = $_SESSION['life_c_campos'];       $_SESSION['life_c_campos'] = $campos;
        $_SESSION['life_c_termo_pesquisa'] = $_SESSION['life_c_termo'];         $_SESSION['life_c_termo'] = '';
        $filtros = 'c';
      } else {
        $filtros = 'i';
      }
    ...
    public function exibeRelacaoOutrosObjetosAprendizagemCapa() {
      ...
      if (isset($_SESSION['life_c_campos_pesquisa'])) {
        $_SESSION['life_c_campos'] = $_SESSION['life_c_campos_pesquisa'];      unset($_SESSION['life_c_campos_pesquisa']);
        $_SESSION['life_c_termo'] = $_SESSION['life_c_termo_pesquisa'];        unset($_SESSION['life_c_termo_pesquisa']);
      }
