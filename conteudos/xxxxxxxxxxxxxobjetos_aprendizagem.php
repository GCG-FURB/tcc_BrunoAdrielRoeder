...
class ObjetoAprendizagem
{
    ...
    private function listarAcoes($secao, $subsecao, $item, $ativas, $ordem)
    {
        ...
        $opcao['indice']= $id;
        $id+= 1;
        $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&od=oa&at=".$ativas;
        $opcao['descricao']= "Ordenar por Objetos de Aprendizagem";
        $opcoes[]= $opcao;
        $opcao= array();
        $opcao['indice']= $id;
        $id+= 1;
        $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&od=pe&at=".$ativas;
        $opcao['descricao']= "Ordenar por Responsáveis";
        $opcoes[]= $opcao;
        $opcao= array();
        $opcao['indice']= $id;
        $id+= 1;
        ...
        foreach ($opcoes as $op) {
            $nome = 'comandos_filtros_'.$op['indice'];
...
//**************BANCO DE DADOS**************************************************    
    public function selectObjetosAprendizagem($eh_ativo, $ordem, $inicio, $limite)
    {
        if (isset($_SESSION['life_c_termo'])) {
            $termo_1 = $_SESSION['life_c_termo'];
        } else {
            $_SESSION['life_c_termo'] = '';
            $termo_1 = '';
        }
        if (isset($_SESSION['life_c_campos'])) {
            $campo_1 = $_SESSION['life_c_campos'];
        } else {
                ...
                case "general":
                    ...
                    switch ($campo_1) {
                        case "ds_identifier":
                            ...
                            break;
                        case "ds_title":
                            $sql.= "WHERE UPPER(ds_title) LIKE UPPER('$termo_1_a') OR UPPER(ds_title) LIKE UPPER('$termo_1_b') OR UPPER(ds_title) LIKE UPPER('$termo_1_c') OR UPPER(ds_title) = UPPER('$termo_1_d'))";
                            break;
                        case "cd_language":
                            $sql.= "WHERE cd_language IN ( ".
                            ...
                            break;
                        case "ds_description":
                            $sql.= "WHERE UPPER(ds_description) LIKE UPPER('$termo_1_a') OR UPPER(ds_description) LIKE UPPER('$termo_1_b') OR UPPER(ds_description) LIKE UPPER('$termo_1_c') OR UPPER(ds_description) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_keyword":
                            $sql.= "WHERE UPPER(ds_keyword) LIKE UPPER('$termo_1_a') OR UPPER(ds_keyword) LIKE UPPER('$termo_1_b') OR UPPER(ds_keyword) LIKE UPPER('$termo_1_c') OR UPPER(ds_keyword) = UPPER('$termo_1_d'))";
                            break;
                        case "cd_coverage":
                            $sql.= "WHERE cd_coverage IN ( ".
                            ...
                            break;
                        case "ds_structure":
                            $sql.= "WHERE UPPER(ds_structure) LIKE UPPER('$termo_1_a') OR UPPER(ds_structure) LIKE UPPER('$termo_1_b') OR UPPER(ds_structure) LIKE UPPER('$termo_1_c') OR UPPER(ds_structure) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_agregation_level":
                            $sql.= "WHERE UPPER(ds_agregation_level) LIKE UPPER('$termo_1_a') OR UPPER(ds_agregation_level) LIKE UPPER('$termo_1_b') OR UPPER(ds_agregation_level) LIKE UPPER('$termo_1_c') OR UPPER(ds_agregation_level) = UPPER('$termo_1_d'))";
                            break;
                ...
                case "lyfe_cycle":
                    ...
                    switch ($campo_1) {
                        ...
                        case "cd_status":
                            ...
                            break;
                        case "ds_contribute":
                            $sql.= "WHERE UPPER(ds_contribute) LIKE UPPER('$termo_1_a') OR UPPER(ds_contribute) LIKE UPPER('$termo_1_b') OR UPPER(ds_contribute) LIKE UPPER('$termo_1_c') OR UPPER(ds_contribute) = UPPER('$termo_1_d'))";
                            break;
                ...
                case "meta_metadata":
                    ...
                    switch ($campo_1) {
                        ...
                        case "ds_contribute":
                            $sql.= "WHERE UPPER(ds_contribute) LIKE UPPER('$termo_1_a') OR UPPER(ds_contribute) LIKE UPPER('$termo_1_b') OR UPPER(ds_contribute) LIKE UPPER('$termo_1_c') OR UPPER(ds_contribute) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_metadata_schema":
                            $sql.= "WHERE UPPER(ds_metadata_schema) LIKE UPPER('$termo_1_a') OR UPPER(ds_metadata_schema) LIKE UPPER('$termo_1_b') OR UPPER(ds_metadata_schema) LIKE UPPER('$termo_1_c') OR UPPER(ds_metadata_schema) = UPPER('$termo_1_d'))";
                            break;
                        case "cd_language":
                            $sql.= "WHERE cd_language IN ( ".
                                                   "  SELECT cd_linguagem FROM life_linguagens WHERE UPPER(nm_linguagem) LIKE UPPER('$termo_1_a') OR UPPER(nm_linguagem) LIKE UPPER('$termo_1_b') OR UPPER(nm_linguagem) LIKE UPPER('$termo_1_c') OR UPPER(nm_linguagem) = UPPER('$termo_1_d')) ".
                ...
                case "technical":
                    ...
                    switch ($campo_1) {
                        case "cd_format":
                            ...
                            break;
                        case "ds_size":
                            $sql.= "WHERE UPPER(ds_size) LIKE UPPER('$termo_1_a') OR UPPER(ds_size) LIKE UPPER('$termo_1_b') OR UPPER(ds_size) LIKE UPPER('$termo_1_c') OR UPPER(ds_size) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_location":
                            $sql.= "WHERE UPPER(ds_location) LIKE UPPER('$termo_1_a') OR UPPER(ds_location) LIKE UPPER('$termo_1_b') OR UPPER(ds_location) LIKE UPPER('$termo_1_c') OR UPPER(ds_location) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_requirement":
                            $sql.= "WHERE UPPER(ds_requirement) LIKE UPPER('$termo_1_a') OR UPPER(ds_requirement) LIKE UPPER('$termo_1_b') OR UPPER(ds_requirement) LIKE UPPER('$termo_1_c') OR UPPER(ds_requirement) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_composite":
                            $sql.= "WHERE UPPER(ds_composite) LIKE UPPER('$termo_1_a') OR UPPER(ds_composite) LIKE UPPER('$termo_1_b') OR UPPER(ds_composite) LIKE UPPER('$termo_1_c') OR UPPER(ds_composite) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_installation_remarks":
                            $sql.= "WHERE UPPER(ds_installation_remarks) LIKE UPPER('$termo_1_a') OR UPPER(ds_installation_remarks) LIKE UPPER('$termo_1_b') OR UPPER(ds_installation_remarks) LIKE UPPER('$termo_1_c') OR UPPER(ds_installation_remarks) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_other_plataforms_requirements":
                            $sql.= "WHERE UPPER(ds_other_plataforms_requirements) LIKE UPPER('$termo_1_a') OR UPPER(ds_other_plataforms_requirements) LIKE UPPER('$termo_1_b') OR UPPER(ds_other_plataforms_requirements) LIKE UPPER('$termo_1_c') OR UPPER(ds_other_plataforms_requirements) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_duration":
                            $sql.= "WHERE UPPER(ds_duration) LIKE UPPER('$termo_1_a') OR UPPER(ds_duration) LIKE UPPER('$termo_1_b') OR UPPER(ds_duration) LIKE UPPER('$termo_1_c') OR UPPER(ds_duration) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_supported_plataform":
                            $sql.= "WHERE UPPER(ds_supported_plataform) LIKE UPPER('$termo_1_a') OR UPPER(ds_supported_plataform) LIKE UPPER('$termo_1_b') OR UPPER(ds_supported_plataform) LIKE UPPER('$termo_1_c') OR UPPER(ds_supported_plataform) = UPPER('$termo_1_d'))";
                            break;
                ...
                case "technical_plataform_specific_features":
                    ...
                    switch ($campo_1) {
                        case "ds_plataform_type":
                            ...
                            break;
                        case "ds_specific_format":
                            $sql.= "WHERE UPPER(ds_specific_format) LIKE UPPER('$termo_1_a') OR UPPER(ds_specific_format) LIKE UPPER('$termo_1_b') OR UPPER(ds_specific_format) LIKE UPPER('$termo_1_c') OR UPPER(ds_specific_format) = UPPER('$termo_1_d')))";
                            break;
                        case "ds_specific_size":
                            $sql.= "WHERE UPPER(ds_specific_size) LIKE UPPER('$termo_1_a') OR UPPER(ds_specific_size) LIKE UPPER('$termo_1_b') OR UPPER(ds_specific_size) LIKE UPPER('$termo_1_c') OR UPPER(ds_specific_size) = UPPER('$termo_1_d')))";
                            break;
                        case "ds_specific_location":
                            $sql.= "WHERE UPPER(ds_specific_location) LIKE UPPER('$termo_1_a') OR UPPER(ds_specific_location) LIKE UPPER('$termo_1_b') OR UPPER(ds_specific_location) LIKE UPPER('$termo_1_c') OR UPPER(ds_specific_location) = UPPER('$termo_1_d')))";
                            break;
                        case "ds_specific_requeriments":
                            $sql.= "WHERE UPPER(ds_specific_requeriments) LIKE UPPER('$termo_1_a') OR UPPER(ds_specific_requeriments) LIKE UPPER('$termo_1_b') OR UPPER(ds_specific_requeriments) LIKE UPPER('$termo_1_c') OR UPPER(ds_specific_requeriments) = UPPER('$termo_1_d')))";
                            break;
                        case "ds_specific_instalation_remarks":
                            $sql.= "WHERE UPPER(ds_specific_instalation_remarks) LIKE UPPER('$termo_1_a') OR UPPER(ds_specific_instalation_remarks) LIKE UPPER('$termo_1_b') OR UPPER(ds_specific_instalation_remarks) LIKE UPPER('$termo_1_c') OR UPPER(ds_specific_instalation_remarks) = UPPER('$termo_1_d')))";
                            break;
                        case "ds_specific_other_plataform_requeriments":
                            $sql.= "WHERE UPPER(ds_specific_other_plataform_requeriments) LIKE UPPER('$termo_1_a') OR UPPER(ds_specific_other_plataform_requeriments) LIKE UPPER('$termo_1_b') OR UPPER(ds_specific_other_plataform_requeriments) LIKE UPPER('$termo_1_c') OR UPPER(ds_specific_other_plataform_requeriments) = UPPER('$termo_1_d')))";
                            break;
                ...
                case "technical_service":
                    ...
                    switch ($campo_1) {
                        ...
                        case "cd_type":
                            ...
                            break;
                        case "ds_provides":
                            $sql.= "WHERE UPPER(ds_provides) LIKE UPPER('$termo_1_a') OR UPPER(ds_provides) LIKE UPPER('$termo_1_b') OR UPPER(ds_provides) LIKE UPPER('$termo_1_c') OR UPPER(ds_provides) = UPPER('$termo_1_d')))";
                            break;
                        case "ds_essential":
                            $sql.= "WHERE UPPER(ds_essential) LIKE UPPER('$termo_1_a') OR UPPER(ds_essential) LIKE UPPER('$termo_1_b') OR UPPER(ds_essential) LIKE UPPER('$termo_1_c') OR UPPER(ds_essential) = UPPER('$termo_1_d')))";
                            break;
                        case "ds_protocol":
                            $sql.= "WHERE UPPER(ds_protocol) LIKE UPPER('$termo_1_a') OR UPPER(ds_protocol) LIKE UPPER('$termo_1_b') OR UPPER(ds_protocol) LIKE UPPER('$termo_1_c') OR UPPER(ds_protocol) = UPPER('$termo_1_d')))";
                            break;
                        case "ds_ontology":
                            $sql.= "WHERE UPPER(ds_ontology) LIKE UPPER('$termo_1_a') OR UPPER(ds_ontology) LIKE UPPER('$termo_1_b') OR UPPER(ds_ontology) LIKE UPPER('$termo_1_c') OR UPPER(ds_ontology) = UPPER('$termo_1_d')))";
                            break;
                        case "cd_language":
                            $sql.= "WHERE cd_language IN ( ".
                                                "  SELECT cd_linguagem FROM life_linguagens WHERE UPPER(nm_linguagem) LIKE UPPER('$termo_1_a') OR UPPER(nm_linguagem) LIKE UPPER('$termo_1_b') OR UPPER(nm_linguagem) LIKE UPPER('$termo_1_c') OR UPPER(nm_linguagem) = UPPER('$termo_1_d') ) ".
                            ...
                            break;
                        case "ds_details":
                            $sql.= "WHERE UPPER(ds_details) LIKE UPPER('$termo_1_a') OR UPPER(ds_details) LIKE UPPER('$termo_1_b') OR UPPER(ds_details) LIKE UPPER('$termo_1_c') OR UPPER(ds_details) = UPPER('$termo_1_d')))";
                            break;
                ...
                case "educational":
                    ...
                    switch ($campo_1) {
                        case "ds_interactivity_type":
                            ...
                            break;
                        case "ds_learning_resource_type":
                            $sql.= "WHERE UPPER(ds_learning_resource_type) LIKE UPPER('$termo_1_a') OR UPPER(ds_learning_resource_type) LIKE UPPER('$termo_1_b') OR UPPER(ds_learning_resource_type) LIKE UPPER('$termo_1_c') OR UPPER(ds_learning_resource_type) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_interactivity_level":
                            $sql.= "WHERE UPPER(ds_interactivity_level) LIKE UPPER('$termo_1_a') OR UPPER(ds_interactivity_level) LIKE UPPER('$termo_1_b') OR UPPER(ds_interactivity_level) LIKE UPPER('$termo_1_c') OR UPPER(ds_interactivity_level) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_sem_antic_density":
                            $sql.= "WHERE UPPER(ds_sem_antic_density) LIKE UPPER('$termo_1_a') OR UPPER(ds_sem_antic_density) LIKE UPPER('$termo_1_b') OR UPPER(ds_sem_antic_density) LIKE UPPER('$termo_1_c') OR UPPER(ds_sem_antic_density) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_intended_end_user_role":
                            $sql.= "WHERE UPPER(ds_intended_end_user_role) LIKE UPPER('$termo_1_a') OR UPPER(ds_intended_end_user_role) LIKE UPPER('$termo_1_b') OR UPPER(ds_intended_end_user_role) LIKE UPPER('$termo_1_c') OR UPPER(ds_intended_end_user_role) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_context":
                            $sql.= "WHERE UPPER(ds_context) LIKE UPPER('$termo_1_a') OR UPPER(ds_context) LIKE UPPER('$termo_1_b') OR UPPER(ds_context) LIKE UPPER('$termo_1_c') OR UPPER(ds_context) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_typical_age_range":
                            $sql.= "WHERE UPPER(ds_typical_age_range) LIKE UPPER('$termo_1_a') OR UPPER(ds_typical_age_range) LIKE UPPER('$termo_1_b') OR UPPER(ds_typical_age_range) LIKE UPPER('$termo_1_c') OR UPPER(ds_typical_age_range) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_difficulty":
                            $sql.= "WHERE UPPER(ds_difficulty) LIKE UPPER('$termo_1_a') OR UPPER(ds_difficulty) LIKE UPPER('$termo_1_b') OR UPPER(ds_difficulty) LIKE UPPER('$termo_1_c') OR UPPER(ds_difficulty) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_typical_learning_time":
                            $sql.= "WHERE UPPER(ds_typical_learning_time) LIKE UPPER('$termo_1_a') OR UPPER(ds_typical_learning_time) LIKE UPPER('$termo_1_b') OR UPPER(ds_typical_learning_time) LIKE UPPER('$termo_1_c') OR UPPER(ds_typical_learning_time) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_description":
                            $sql.= "WHERE UPPER(ds_description) LIKE UPPER('$termo_1_a') OR UPPER(ds_description) LIKE UPPER('$termo_1_b') OR UPPER(ds_description) LIKE UPPER('$termo_1_c') OR UPPER(ds_description) = UPPER('$termo_1_d'))";
                            break;
                        case "cd_language":
                            $sql.= "WHERE cd_language IN ( ".
                                                             ...
                                                             ")";
                            break;
                        case "ds_learning_content_type":
                            $sql.= "WHERE UPPER(ds_learning_content_type) LIKE UPPER('$termo_1_a') OR UPPER(ds_learning_content_type) LIKE UPPER('$termo_1_b') OR UPPER(ds_learning_content_type) LIKE UPPER('$termo_1_c') OR UPPER(ds_learning_content_type) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_interaction":
                            $sql.= "WHERE UPPER(ds_interaction) LIKE UPPER('$termo_1_a') OR UPPER(ds_interaction) LIKE UPPER('$termo_1_b') OR UPPER(ds_interaction) LIKE UPPER('$termo_1_c') OR UPPER(ds_interaction) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_didatic_strategy":
                            $sql.= "WHERE UPPER(ds_didatic_strategy) LIKE UPPER('$termo_1_a') OR UPPER(ds_didatic_strategy) LIKE UPPER('$termo_1_b') OR UPPER(ds_didatic_strategy) LIKE UPPER('$termo_1_c') OR UPPER(ds_didatic_strategy) = UPPER('$termo_1_d'))";
                            break;
                ...
                case "rights":
                    ...
                    switch ($campo_1) {
                        case "ds_cost":
                            ...
                            break;
                        case "ds_copyright_and_other_restrictions":
                            $sql.= "WHERE UPPER(ds_copyright_and_other_restrictions) LIKE UPPER('$termo_1_a') OR UPPER(ds_copyright_and_other_restrictions) LIKE UPPER('$termo_1_b') OR UPPER(ds_copyright_and_other_restrictions) LIKE UPPER('$termo_1_c') OR UPPER(ds_copyright_and_other_restrictions) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_description":
                            $sql.= "WHERE UPPER(ds_description) LIKE UPPER('$termo_1_a') OR UPPER(ds_description) LIKE UPPER('$termo_1_b') OR UPPER(ds_description) LIKE UPPER('$termo_1_c') OR UPPER(ds_description) = UPPER('$termo_1_d'))";
                            break;
                ...
                case "relation":
                    ...
                    switch ($campo_1) {
                        case "ds_kind":
                            ...
                            break;
                        case "ds_resource":
                            $sql.= "WHERE UPPER(ds_resource) LIKE UPPER('$termo_1_a') OR UPPER(ds_resource) LIKE UPPER('$termo_1_b') OR UPPER(ds_resource) LIKE UPPER('$termo_1_c') OR UPPER(ds_resource) = UPPER('$termo_1_d'))";
                            break;
                ...
                case "annotation":
                    ...
                    switch ($campo_1) {
                        case "ds_entity":
                            ...
                            break;
                        case "ds_date":
                            $sql.= "WHERE UPPER(ds_date) LIKE UPPER('$termo_1_a') OR UPPER(ds_date) LIKE UPPER('$termo_1_b') OR UPPER(ds_date) LIKE UPPER('$termo_1_c') OR UPPER(ds_date) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_description":
                            $sql.= "WHERE UPPER(ds_description) LIKE UPPER('$termo_1_a') OR UPPER(ds_description) LIKE UPPER('$termo_1_b') OR UPPER(ds_description) LIKE UPPER('$termo_1_c') OR UPPER(ds_description) = UPPER('$termo_1_d'))";
                            break;
                ...
                case "classification":
                    ...
                    switch ($campo_1) {
                        case "ds_purpose":
                            ...
                            break;
                        case "ds_taxon_path":
                            $sql.= "WHERE UPPER(ds_taxon_path) LIKE UPPER('$termo_1_a') OR UPPER(ds_taxon_path) LIKE UPPER('$termo_1_b') OR UPPER(ds_taxon_path) LIKE UPPER('$termo_1_c') OR UPPER(ds_taxon_path) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_description":
                            $sql.= "WHERE UPPER(ds_description) LIKE UPPER('$termo_1_a') OR UPPER(ds_description) LIKE UPPER('$termo_1_b') OR UPPER(ds_description) LIKE UPPER('$termo_1_c') OR UPPER(ds_description) = UPPER('$termo_1_d'))";
                            break;
                ...
                case "acessibility":
                    ...
                    switch ($campo_1) {
                        case "ds_has_visual":
                            ...
                            break;
                        case "ds_has_audititory":
                            $sql.= "WHERE UPPER(ds_has_audititory) LIKE UPPER('$termo_1_a') OR UPPER(ds_has_audititory) LIKE UPPER('$termo_1_b') OR UPPER(ds_has_audititory) LIKE UPPER('$termo_1_c') OR UPPER(ds_has_audititory) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_has_text":
                            $sql.= "WHERE UPPER(ds_has_text) LIKE UPPER('$termo_1_a') OR UPPER(ds_has_text) LIKE UPPER('$termo_1_b') OR UPPER(ds_has_text) LIKE UPPER('$termo_1_c') OR UPPER(ds_has_text) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_has_tactible":
                            $sql.= "WHERE UPPER(ds_has_tactible) LIKE UPPER('$termo_1_a') OR UPPER(ds_has_tactible) LIKE UPPER('$termo_1_b') OR UPPER(ds_has_tactible) LIKE UPPER('$termo_1_c') OR UPPER(ds_has_tactible) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_earl_statment":
                            $sql.= "WHERE UPPER(ds_earl_statment) LIKE UPPER('$termo_1_a') OR UPPER(ds_earl_statment) LIKE UPPER('$termo_1_b') OR UPPER(ds_earl_statment) LIKE UPPER('$termo_1_c') OR UPPER(ds_earl_statment) = UPPER('$termo_1_d'))";
                            break;
                        case "ds_equivalent_resource":
                            $sql.= "WHERE UPPER(ds_equivalent_resource) LIKE UPPER('$termo_1_a') OR UPPER(ds_equivalent_resource) LIKE UPPER('$termo_1_b') OR UPPER(ds_equivalent_resource) LIKE UPPER('$termo_1_c') OR UPPER(ds_equivalent_resource) = UPPER('$termo_1_d'))";
                            break;
                ...
                case "segment_information_table":
                    ...
                    switch ($campo_1) {
                        case "ds_segment_list":
                            ...
                            break;
                        case "ds_segmente_group_list":
                            $sql.= "WHERE UPPER(ds_segmente_group_list) LIKE UPPER('$termo_1_a') OR UPPER(ds_segmente_group_list) LIKE UPPER('$termo_1_b') OR UPPER(ds_segmente_group_list) LIKE UPPER('$termo_1_c') OR UPPER(ds_segmente_group_list) = UPPER('$termo_1_d'))";
                            break;
