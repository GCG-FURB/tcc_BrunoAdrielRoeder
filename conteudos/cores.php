<?php
  class Cor {
    ...
    public function retornaSeletorCores($cd_cor) {
      ...
      echo "      <tr>\n";
      echo " 	      <td class=\"celConteudoChamada\">Cor *</td>\n";
      echo "  		  <td class=\"celConteudoCampo\">\n";
      echo "          <span id=\"area_cd_periodo\">\n";
      echo "            <select name=\"cd_cor\" id=\"cd_cor\" class=\"fontConteudoCampoSeletorHint\" style=\"width:100%;\">\n";
      echo "  		  	    <option ";
      ...
      foreach ($itens as $it) {
        ...
        if (!$achou) {
          ...
          echo " value=\"".$it['cd_cor']."\" class=\"fontConteudo\" style=\"color:black;background-color:".$it['ds_cor'].";\">".$it['nm_cor']."</option>\n";
        }
      }
      echo "          </select>\n";      
      echo "          </span>\n";
