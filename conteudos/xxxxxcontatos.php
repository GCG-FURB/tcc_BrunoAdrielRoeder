<?php
  class Contato {
    ...
    public function imprimeFormularioContatos($titulo, $cd_contato, $exibir_residencial=true) {
      ...
      $util->linhaTresCamposTextAcao(0, 'Telefone(s) comercial(is) ', 'nr_telefone_comercial_01', 14, 34.5, $nr_telefone_comercial_01, " onKeyPress=\"mascaraTelefone('nr_telefone_comercial_01')\"; onBlur=\"validaTelefone('nr_telefone_comercial_01');\" ", 'nr_telefone_comercial_02', 14, 32, $nr_telefone_comercial_02, " onKeyPress=\"mascaraTelefone('nr_telefone_comercial_02')\"; onBlur=\"validaTelefone('nr_telefone_comercial_02');\" ", 'nr_telefone_comercial_03', 14, 32, $nr_telefone_comercial_03, " onKeyPress=\"mascaraTelefone('nr_telefone_comercial_03')\"; onBlur=\"validaTelefone('nr_telefone_comercial_03');\" ");
      if ($exibir_residencial) {
        $util->linhaTresCamposTextAcao(0, 'Telefone(s) residencial(is) ', 'nr_telefone_residencial_01', 14, 34.5, $nr_telefone_residencial_01, " onKeyPress=\"mascaraTelefone('nr_telefone_residencial_01')\"; onBlur=\"validaTelefone('nr_telefone_residencial_01');\" ", 'nr_telefone_residencial_02', 14, 32, $nr_telefone_residencial_02, " onKeyPress=\"mascaraTelefone('nr_telefone_residencial_02')\"; onBlur=\"validaTelefone('nr_telefone_residencial_02');\" ", 'nr_telefone_residencial_03', 14, 32, $nr_telefone_residencial_03, " onKeyPress=\"mascaraTelefone('nr_telefone_residencial_03')\"; onBlur=\"validaTelefone('nr_telefone_residencial_03');\" ");
      } else {
      ...
      $util->linhaTresCamposTextAcao(0, 'Telefone(s) celular(es): ', 'nr_telefone_celular_01', 14, 34.5, $nr_telefone_celular_01, " onKeyPress=\"mascaraTelefone('nr_telefone_celular_01')\"; onBlur=\"validaTelefone('nr_telefone_celular_01');\" ", 'nr_telefone_celular_02', 14, 32, $nr_telefone_celular_02, " onKeyPress=\"mascaraTelefone('nr_telefone_celular_02')\"; onBlur=\"validaTelefone('nr_telefone_celular_02');\" ", 'nr_telefone_celular_03', 14, 32, $nr_telefone_celular_03, " onKeyPress=\"mascaraTelefone('nr_telefone_celular_03')\"; onBlur=\"validaTelefone('nr_telefone_celular_03');\" ");
      ...
      $util->linhaUmCampoText(0, 'E-mail 03: ', 'ds_email_03', 100, 100, $ds_email_03);
      $util->linhaUmCampoText(0, 'Skype: ', 'ds_skype', 100, 100, $ds_skype);
      $util->linhaUmCampoText(0, 'MSN: ', 'ds_messenger', 100, 100, $ds_messenger);
      $util->linhaUmCampoText(0, 'GTalk: ', 'ds_gtalk', 100, 100, $ds_gtalk);
