...
//**************BANCO DE DADOS**************************************************    
    public function selectAreasConhecimentoPessoa($cd_area_conhecimento, $cd_pessoa, $eh_ativo) {
      ...
      $result_id = @mysql_query($sql) or die ("Erro no banco de dados - TABELA ÁREAS CONHECIMENTO PESSOA 01!");
      $dados = array();
    ...
    public function selectDadosAreaConhecimentoPessoa($cd_area_conhecimento, $cd_pessoa, $eh_ativo) {
      ...
      $sql.= "ORDER BY ac.nm_area_conhecimento ";
      $result_id = @mysql_query($sql) or die ("Erro no banco de dados - TABELA ÁREAS CONHECIMENTO PESSOA 02!");
    ...
    private function registrarAreasConhecimentoPessoa($cd_pessoa, $cd_area_conhecimento) {
      ...
      mysql_query($sql) or die ("Erro no banco de dados - TABELA ÁREAS CONHECIMENTO PESSOA 03!");
    ...
    private function inativarAreasConhecimentoPessoa($cd_pessoa) {
      ...
      require_once 'includes/utilitarios.php';                                  $util= new Utilitario();
      $util->gerarLog($sql, 'areas_conhecimento_pessoa');
      mysql_query($sql) or die ("Erro no banco de dados - TABELA ÁREAS CONHECIMENTO PESSOA 04!");
      $saida = mysql_affected_rows();
      return $saida;     
    }    
    ...
    private function ativarAreasConhecimentoPessoa($cd_pessoa, $cd_area_conhecimento) {
      ...
      require_once 'includes/utilitarios.php';                                  $util= new Utilitario();
      $util->gerarLog($sql, 'areas_conhecimento_pessoa');
      mysql_query($sql) or die ("Erro no banco de dados - TABELA ÁREAS CONHECIMENTO PESSOA 05!");
      $saida = mysql_affected_rows();
      return $saida;
    }
  }
