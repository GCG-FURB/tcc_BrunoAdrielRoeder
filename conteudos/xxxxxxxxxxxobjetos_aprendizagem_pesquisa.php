...
class ObjetoAprendizagemPesquisa
{
    ...
    public function listarOpcoesPesquisaAvancada($secao, $subsecao, $item, $ativas, $ordem, $eh_permitir_simples)
    {
        ...
        if (isset($_SESSION['life_c_termo_1'])) {
            $termo_1 = $_SESSION['life_c_termo_1'];
        } else {
            $_SESSION['life_c_termo_1'] = '';
            $termo_1 = '';
        }
        if (isset($_SESSION['life_c_tabela_1'])) {
            $tabela_1 = $_SESSION['life_c_tabela_1'];
        } else {
            $_SESSION['life_c_tabela_1'] = '';
            $tabela_1 = '';
        }
        if (isset($_SESSION['life_c_campo_1'])) {
            $campo_1 = $_SESSION['life_c_campo_1'];
        } else {
            $_SESSION['life_c_campo_1'] = '';
            $campo_1 = '';
        }
...
/*      echo "        <td class=\"celConteudo\" style=\"width:25%;\">\n";
    ...
    public function pesquisarSimples($secao, $subsecao, $item, $ativas, $ordem)
    {
        ...
        $termo_1 = $util->limparVariavel($_POST['termo_1']);
        $_SESSION['life_c_termo_1'] = $termo_1;
        $campo_1 = addslashes($_POST['campo_1']);
        $_SESSION['life_c_campo_1'] = $campo_1;
        $tabela_1 = addslashes($_POST['tabela_1']);
        $_SESSION['life_c_tabela_1'] = $tabela_1;
    ...
    public function retornaDetalhesPesquisa()
    {
        ...
        if ($termo_1 != '') {
            ...
            switch ($tabela_1) {
                case "general":
                    $saida.= "<br />Seção: Dados Gerais\n";
                    break;
                case "lyfe_cycle":
                    $saida.= "<br />Seção: Ciclo de Vida\n";
                    break;
                case "meta-metadata":
                    $saida.= "<br />Seção: Meta-Metadata\n";
                    break;
                case "technical":
                    $saida.= "<br />Seção: Informações Técnicas\n";
                    break;
                case "plataform_specific_features":
                    $saida.= "<br />Seção: Informações Técnicas - Características Específicas\n";
                    break;
                case "service":
                    $saida.= "<br />Seção: Informações Técnicas - Serviço\n";
                    break;
                case "educational":
                    $saida.= "<br />Seção: Educacional\n";
                    break;
                case "rights":
                    $saida.= "<br />Seção: Direitos Autorais\n";
                    break;
                case "relation":
                    $saida.= "<br />Seção: Relação\n";
                    break;
                case "annotation":
                    $saida.= "<br />Seção: Anotação\n";
                    break;
                case "classification":
                    $saida.= "<br />Seção: Classificação\n";
                    break;
                case "acessibility":
                    $saida.= "<br />Seção: Acessibilidade\n";
                    break;
                case "segment_information_table":
                    $saida.= "<br />Seção: Segmentos\n";
                    break;
            }
            ...
            if ($campo_1 != 'todos') {
                switch ($campo_1) {
                    case "ds_identifier":
                        $saida.= "<br />Campo: Identificador\n";
                        break;
                    case "ds_title":
                        $saida.= "<br />Campo: Título\n";
                        break;
                    case "cd_language":
                        $saida.= "<br />Campo: Idioma\n";
                        break;
                    case "ds_description":
                        $saida.= "<br />Campo: Descrição\n";
                        break;
                    case "ds_keyword":
                        $saida.= "<br />Campo: Palavra chave\n";
                        break;
                    case "cd_coverage":
                        $saida.= "<br />Campo: Área de Conhecimento\n";
                        break;
                    case "ds_structure":
                        $saida.= "<br />Campo: Estrutura\n";
                        break;
                    case "ds_agregation_level":
                        $saida.= "<br />Campo: Nível de agregação\n";
                        break;
                    case "ds_version":
                        $saida.= "<br />Campo: Versão\n";
                        break;
                    case "cd_status":
                        $saida.= "<br />Campo: Status\n";
                        break;
                    case "ds_contribute":
                        $saida.= "<br />Campo: Contribuição\n";
                        break;
                    case "ds_identifier":
                        $saida.= "<br />Campo: Identificador\n";
                        break;
                    ...
                    case "ds_metadata_schema":
                        $saida.= "<br />Campo: Esquema de Metadados\n";
                        break;
                    case "cd_language":
                        $saida.= "<br />Campo: Idioma\n";
                        break;
                    case "cd_format":
                        $saida.= "<br />Campo: Formato\n";
                        break;
                    case "ds_size":
                        $saida.= "<br />Campo: Tamanho\n";
                        break;
        //            case "ds_location":                                         $saida.= "<br />Campo: Localização\n";                                           break;
                    case "ds_requirement":
                        $saida.= "<br />Campo: Requerimentos\n";
                        break;
                    case "ds_composite":
                        $saida.= "<br />Campo: Composição\n";
                        break;
                    case "ds_installation_remarks":
                        $saida.= "<br />Campo: Observações para a instalação\n";
                        break;
                    case "ds_other_plataforms_requirements":
                        $saida.= "<br />Campo: Outros Requerimentos da plataforma\n";
                        break;
                    case "ds_duration":
                        $saida.= "<br />Campo: Duração\n";
                        break;
                    case "ds_supported_plataform":
                        $saida.= "<br />Campo: Plataformas Suportadas\n";
                        break;
                    case "ds_plataform_type":
                        $saida.= "<br />Campo: Tipo de Plataforma\n";
                        break;
                    case "ds_specific_format":
                        $saida.= "<br />Campo: Formato específico\n";
                        break;
                    case "ds_specific_size":
                        $saida.= "<br />Campo: Tamanho\n";
                        break;
                    case "ds_specific_location":
                        $saida.= "<br />Campo: Localização Específica\n";
                        break;
                    case "ds_specific_requeriments":
                        $saida.= "<br />Campo: Requerimentos específicos\n";
                        break;
                    case "ds_specific_instalation_remarks":
                        $saida.= "<br />Campo: Observações para Instalação\n";
                        break;
                    case "ds_specific_other_plataform_requeriments":
                        $saida.= "<br />Campo: Requerimentos para outras Plataformas\n";
                        break;
                    case "ds_name":
                        $saida.= "<br />Campo: Nome\n";
                        break;
                    case "cd_type":
                        ...
                        break;
                    case "ds_provides":
                        $saida.= "<br />Campo: Fornece\n";
                        break;
                    case "ds_essential":
                        $saida.= "<br />Campo: Essencial\n";
                        break;
                    case "ds_protocol":
                        $saida.= "<br />Campo: Protocolo\n";
                        break;
                    case "ds_ontology":
                        $saida.= "<br />Campo: Ontologia\n";
                        break;
                    case "cd_language":
                        $saida.= "<br />Campo: Idioma\n";
                        break;
                    case "ds_details":
                        $saida.= "<br />Campo: Detalhes\n";
                        break;
                    case "ds_interactivity_type":
                        $saida.= "<br />Campo: Tipo de Interatividade\n";
                        break;
                    case "ds_learning_resource_type":
                        $saida.= "<br />Campo: Recursos do Tipo de Aprendizagem \n";
                        break;
                    case "ds_interactivity_level":
                        $saida.= "<br />Campo: Nível de Interatividade\n";
                        break;
                    case "ds_sem_antic_density":
                        $saida.= "<br />Campo: Densidade Semântica\n";
                        break;
                    case "ds_intended_end_user_role":
                        $saida.= "<br />Campo: Destinação e Função do Usuário\n";
                        break;
                    case "ds_context":
                        $saida.= "<br />Campo: Contexto\n";
                        break;
                    case "ds_typical_age_range":
                        $saida.= "<br />Campo: Faixa Etária\n";
                        break;
                    case "ds_difficulty":
                        $saida.= "<br />Campo: Dificuldade\n";
                        break;
                    case "ds_typical_learning_time":
                        $saida.= "<br />Campo: Tempo de Aprendizagem\n";
                        break;
                    case "ds_description":
                        $saida.= "<br />Campo: Descrição\n";
                        break;
                    ...
                    case "ds_learning_content_type":
                        $saida.= "<br />Campo: Tipo de Conteúdo\n";
                        break;
                    case "ds_interaction":
                        $saida.= "<br />Campo: Interação\n";
                        break;
                    case "ds_didatic_strategy":
                        $saida.= "<br />Campo: Estratégia Didática\n";
                        break;
                    case "ds_cost":
                        $saida.= "<br />Campo: Custo\n";
                        break;
                    case "ds_copyright_and_other_restrictions":
                        $saida.= "<br />Campo: Direitos de autor e outras restrições\n";
                        break;
                    case "ds_description":
                        $saida.= "<br />Campo: Descrição\n";
                        break;
                    case "ds_kind":
                        ...
                        break;
                    case "ds_resource":
                        $saida.= "<br />Campo: Recurso\n";
                        break;
                    case "ds_entity":
                        $saida.= "<br />Campo: Entidade\n";
                        break;
                    case "ds_date":
                        $saida.= "<br />Campo: Data\n";
                        break;
                    case "ds_description":
                        ...
                        break;
                    case "ds_purpose":
                        $saida.= "<br />Campo: Propósito\n";
                        break;
                    case "ds_taxon_path":
                        $saida.= "<br />Campo: Caminho\n";
                        break;
                    case "ds_description":
                        $saida.= "<br />Campo: Descrição\n";
                        break;
                    case "ds_keyword":
                        $saida.= "<br />Campo: Palavras chave\n";
                        break;
                    case "ds_has_visual":
                        $saida.= "<br />Campo: Elementos Visuais\n";
                        break;
                    case "ds_has_audititory":
                        $saida.= "<br />Campo: Elementos Sonoros\n";
                        break;
                    case "ds_has_text":
                        $saida.= "<br />Campo: Elementos de Texto\n";
                        break;
                    case "ds_has_tactible":
                        $saida.= "<br />Campo: Elementos Táteis\n";
                        break;
                    case "ds_earl_statment":
                        $saida.= "<br />Campo: Padrão EARL\n";
                        break;
                    case "ds_equivalent_resource":
                        $saida.= "<br />Campo: Recursos Equivalentes\n";
                        break;
                    case "ds_segment_list":
                        $saida.= "<br />Campo: Segmentos\n";
                        break;
                    case "ds_segmente_group_list":
                        $saida.= "<br />Campo: Grupos\n";
                        break;
                }
            }
        }
