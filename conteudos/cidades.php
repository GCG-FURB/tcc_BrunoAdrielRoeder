...
class Cidade
{
    ...
    private function listarAcoes($secao, $subsecao, $item, $estado, $inicial, $ativas)
    {
        ...
        $util = new Utilitario();
        require_once 'conteudos/estados.php';
        $est = new Estado();
      
        $opcoes_1= array();
        $opcao= array();
        $opcao['indice']= "1";
        $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&in=".$inicial."&es=".$estado."&at=1";
        if ($ativas == '1') {
        ...
        $opcao= array();
        $opcao['indice']= "2";
        $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&in=".$inicial."&es=".$estado."&at=0";
        if ($ativas == '0') {
            $opcao['selecionado'] = ' selected=\"selected\" ';
        } else {
            $opcao['selecionado'] = '';
        ...
        $opcao= array();
        $opcao['indice']= "3";
        $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&in=".$inicial."&es=".$estado."&at=2";
        if ($ativas == '2') {
            $opcao['selecionado'] = ' selected=\"selected\" ';
        } else {
            $opcao['selecionado'] = '';
