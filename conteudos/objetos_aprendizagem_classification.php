<?php
  class ObjetoAprendizagemClassification {
    ...
    public function imprimeFormularioCadastro($eh_informar_classification, $eh_manter_configuracoes_originais, $cd_classification, $ds_purpose, $eh_informar_purpose, $ds_taxon_path, $eh_informar_taxon_path, $ds_description, $eh_informar_description, $ds_keyword, $eh_informar_keyword) {
      ...
      if ($eh_obrigatorio_purpose || $eh_obrigatorio_taxon_path || $eh_obrigatorio_description || $eh_obrigatorio_keyword) {
        ...
        if ($eh_informar_keyword == '1') {
          $util->linhaUmCampoTextHint($eh_obrigatorio_keyword, $conf->retornaDescricaoCampoClassificationPalavraChave().' (Separadas por ponto (.))', $conf->retornaNomeCampoClassificationPalavraChave(), 'ds_classification_keyword', '250', '100', $ds_keyword, 1);
    ...
    public function imprimeDados($cd_classification) {
      ...
      $retorno = '';
      if ($eh_informar_purpose || $eh_informar_taxon_path || $eh_informar_description || $eh_informar_keyword) {
