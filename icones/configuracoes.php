<?php
  class Configuracao {
    ...
    private function montarFormularioConfiguracaoAcesso() {
      ...
      $this->tiluloSecao('Configurações de acesso ao sistema');
      ...
      $this->tiluloSecao('Configurações de cadastro no sistema');
    ...
    private function montarFormularioConfiguracaoPadraoObaa() {
      ...
      $elemento = array();       $elemento[] = 'eh_informar_general_coverage_cadastro_basico';       $elemento[] = 'eh_informar_general_coverage_cadastro_requisitar';       $elemento[] = 'cp_general_coverage_descricao';       $elemento[] = 'cp_general_coverage_nome';       $elemento[] = 'cp_general_coverage_informacao';       $elemento[] = 'eh_apresentar_general_coverage_retorno_pesquisa';       $elemento[] = '';        $titulo = 'Área de conhecimento';        $comentario = '';      $este_elemento = array();         $este_elemento[] = $titulo;         $este_elemento[] = $comentario;          $este_elemento[] = $elemento;    $lista[] = $este_elemento;
