<script>
<!--
function valida_proprio(f) {
  document.getElementById('digitou').value = '0';
  var f = document.getElementById('cadastro_proprio');
  ...
  if (f.nr_cpf.value == '') {
    ...
    document.getElementById('validar').value = '1';
    if (document.getElementById("eh_cpf_valido").value != '1') {
      alert("CPF inválido!");
      return false;
    }
  }
  document.getElementById('cadastro_proprio').submit();
}
