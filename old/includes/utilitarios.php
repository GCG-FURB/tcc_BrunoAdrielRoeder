...
//******************************************************************************    
    ...
    public function linhaUmCampoText($obrigatorio, $descricao, $nome, $maximo, $tamanho, $valor) {
      ...
      echo "        </td>\n";
      echo "  	    <td class=\"celConteudoCampo\">\n";
      echo "          <input type=\"text\" maxlength=\"".$maximo."\" name=\"".$nome."\" id=\"".$nome."\" value=\"".$valor."\" class=\"fontConteudoCampoTextHint\" style=\"width:".$tamanho."%;\" />\n";
      echo "        </td>\n";
      echo "      </tr>\n";    
    }
    ...
    public function linhaUmCampoTextAcao($obrigatorio, $descricao, $nome, $maximo, $tamanho, $valor, $acao) {
      ...
      echo "        </td>\n";
      echo "  	    <td class=\"celConteudoCampo\">\n";
      echo "          <input type=\"text\" maxlength=\"".$maximo."\" name=\"".$nome."\" id=\"".$nome."\" value=\"".$valor."\" class=\"fontConteudoCampoTextHint\" style=\"width:".$tamanho."%;\" ".$acao."/>\n";
      echo "        </td>\n";
      echo "      </tr>\n";    
    }
    ...
    public function linhaTresCamposTextAcao($obrigatorio, $descricao, $nome_1, $maximo_1, $tamanho_1, $valor_1, $acao_1, $nome_2, $maximo_2, $tamanho_2, $valor_2, $acao_2, $nome_3, $maximo_3, $tamanho_3, $valor_3, $acao_3) {
      ...
      echo "          <input type=\"text\" maxlength=\"".$maximo_1."\" name=\"".$nome_1."\" id=\"".$nome_1."\" value=\"".$valor_1."\" class=\"fontConteudoCampoTextHint\" style=\"width:".$tamanho_1."%;\" ".$acao_1."/>\n";
      echo "          <input type=\"text\" maxlength=\"".$maximo_2."\" name=\"".$nome_2."\" id=\"".$nome_2."\" value=\"".$valor_2."\" class=\"fontConteudoCampoTextHint\" style=\"width:".$tamanho_2."%;\" ".$acao_2."/>\n";
      echo "          <input type=\"text\" maxlength=\"".$maximo_3."\" name=\"".$nome_3."\" id=\"".$nome_3."\" value=\"".$valor_3."\" class=\"fontConteudoCampoTextHint\" style=\"width:".$tamanho_3."%;\" ".$acao_3."/>\n";
      echo "        </td>\n";
      echo "      </tr>\n";    
    }
    ...
    public function linhaTresCamposText($obrigatorio, $descricao, $nome_1, $maximo_1, $tamanho_1, $valor_1, $nome_2, $maximo_2, $tamanho_2, $valor_2, $nome_3, $maximo_3, $tamanho_3, $valor_3) {
      ...
      echo "        </td>\n";
      echo "  	    <td class=\"celConteudoCampo\">\n";
      echo "          <input type=\"text\" maxlength=\"".$maximo_1."\" name=\"".$nome_1."\" id=\"".$nome_1."\" value=\"".$valor_1."\" class=\"fontConteudo\" style=\"width:".$tamanho_1."%;\" />\n";
      echo "          &nbsp;/&nbsp;\n";
      echo "          <input type=\"text\" maxlength=\"".$maximo_2."\" name=\"".$nome_2."\" id=\"".$nome_2."\" value=\"".$valor_2."\" class=\"fontConteudo\" style=\"width:".$tamanho_2."%;\" />\n";
      echo "          &nbsp;/&nbsp;\n";
      echo "          <input type=\"text\" maxlength=\"".$maximo_3."\" name=\"".$nome_3."\" id=\"".$nome_3."\" value=\"".$valor_3."\" class=\"fontConteudo\" style=\"width:".$tamanho_3."%;\" />\n";
      echo "        </td>\n";
      echo "      </tr>\n";    
    }
    ...
    public function linhaUmCampoSenha($obrigatorio, $descricao, $nome, $maximo, $tamanho, $valor) {
      ...
      echo "        </td>\n";
      echo "  	    <td class=\"celConteudoCampo\">\n";
      echo "          <input type=\"password\" maxlength=\"".$maximo."\" name=\"".$nome."\" id=\"".$nome."\" value=\"".$valor."\" class=\"fontConteudo\" style=\"width:".$tamanho."%;\" />\n";
      echo "        </td>\n";
      echo "      </tr>\n";    
    }
    ...
    public function linhaUmCampoTextBotao($obrigatorio, $descricao, $nome, $maximo, $tamanho, $valor, $botao) {
      ...
      echo "        </td>\n";
      echo "  	    <td class=\"celConteudoCampo\">\n";
      echo "          <input type=\"text\" maxlength=\"".$maximo."\" name=\"".$nome."\" id=\"".$nome."\" value=\"".$valor."\" class=\"fontConteudo\" style=\"width:".$tamanho."%;\" />\n";
      echo "  		    <input type=\"submit\" class=\"botao\" value=\"".$botao."\">\n";
      echo "        </td>\n";
      echo "      </tr>\n";    
    }
    ...
    public function linhaDoisCamposText($obrigatorio, $descricao, $nome1, $maximo1, $tamanho1, $valor1, $nome2, $maximo2, $tamanho2, $valor2) {
      ...
      echo "        </td>\n";
      echo "  	    <td class=\"celConteudoCampo\">\n";
      echo "          <input type=\"text\" maxlength=\"".$maximo1."\" name=\"".$nome1."\" id=\"".$nome1."\" value=\"".$valor1."\" class=\"fontConteudo\" style=\"width:".$tamanho_1."%;\" />\n";
      echo "          <input type=\"text\" maxlength=\"".$maximo2."\" name=\"".$nome2."\" id=\"".$nome2."\" value=\"".$valor2."\" class=\"fontConteudo\" style=\"width:".$tamanho_2."%;\" />\n";
      echo "        </td>\n";
      echo "      </tr>\n";    
    }
    ...
    public function linhaSeletor($descricao, $nome, $setado, $opcoes, $tamanho) {
      ...
      echo " 	      <td class=\"celConteudoChamada\">".$descricao."</td>\n";
      echo "  		  <td class=\"celConteudoCampo\">\n";
      echo "          <select name=\"".$nome."\" id=\"".$nome."\" class=\"fontConteudoCampoSeletorHint\" style=\"width:".$tamanho."%;\">\n";
      foreach ($opcoes as $op) {
        echo "  			    <option ";
        if ($op[0] == $setado) {
          echo " selected ";
    ...
    public function linhaBotao($valor) {
      ...
      echo "  		  <input type=\"submit\" class=\"botao\" value=\"".$valor."\" tabindex=\"1\">\n";
      echo "      </td>\n";
      echo "  	</tr>\n";					    
    }
    ...
    public function linhaUmCampoArquivo($obrigatorio, $descricao, $nome, $maximo, $tamanho, $valor) {
      ...
      echo "        </td>\n";
      echo "  	    <td class=\"celConteudoCampo\">\n";
      echo "          <input type=\"file\" maxlength=\"".$maximo."\" name=\"".$nome."\" id=\"".$nome."\" value=\"".$valor."\" class=\"fontConteudo\" style=\"width:".$tamanho."%;\" />\n";
      echo "        </td>\n";
      echo "      </tr>\n";    
    }
