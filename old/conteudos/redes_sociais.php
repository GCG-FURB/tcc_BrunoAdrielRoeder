<?php
  class RedeSocial {
    ...
    private function montarFormularioCadastro($link) {
      ...
      $this->imprimeFormularioCadastro($link, $cd_rede_social, $nm_rede_social, $ds_arquivo_logo_compartilhamento, $lk_rede_social, $eh_exibir, $eh_ativo, $eh_editavel);
    }
    ...
    public function imprimeFormularioCadastro($link, $cd_rede_social, $nm_rede_social, $ds_arquivo_logo_compartilhamento, $lk_rede_social, $eh_exibir, $eh_ativo, $eh_editavel) {
      require_once 'includes/utilitarios.php';                                  $util = new Utilitario();
      ...
      $util->linhaSeletor('Exibir a Rede para compartilhamentos: ', 'eh_exibir', $eh_exibir, $opcoes, '100');
    ...
    public function salvarCadastroAlteracao() {
      ...
      if ($cd_rede_social > 0) {
        if ($this->alteraRedeSocial($cd_rede_social, $nm_rede_social, $ds_arquivo_logo_compartilhamento, $lk_rede_social, $eh_exibir, $eh_ativo, $lk_seo)) {
        ...
        if ($this->insereRedeSocial($nm_rede_social, $ds_arquivo_logo_compartilhamento, $lk_rede_social, $eh_exibir, $eh_ativo, $lk_seo)) {
    ...
    public function retornaOpcaoCompartilhamento($url, $titulo) {
      ...
      $redes = $this->selectRedesSociais('1', '1');
      if (count($redes) > 0) {
        echo "      Compartilhe: ";
        foreach ($redes as $r) {
...
//**************BANCO DE DADOS**************************************************    
    public function selectRedesSociais($eh_ativo, $eh_exibir) {
      $sql  = "SELECT * ".
    ...
    public function insereRedeSocial($nm_rede_social, $ds_arquivo_logo_compartilhamento, $lk_rede_social, $eh_exibir, $eh_ativo, $lk_seo) {
      $cd_usuario_cadastro = $_SESSION['life_codigo'];
      $dt_cadastro = date('Y-m-d');
      $sql = "INSERT INTO life_redes_sociais ".
             "(nm_rede_social, ds_arquivo_logo_compartilhamento, lk_rede_social, eh_exibir, eh_ativo, cd_usuario_cadastro, dt_cadastro, lk_seo) ".
             "VALUES ".
             "(\"$nm_rede_social\", \"$ds_arquivo_logo_compartilhamento\", \"$lk_rede_social\", \"$eh_exibir\", \"$eh_ativo\", \"$cd_usuario_cadastro\", \"$dt_cadastro\", \"$lk_seo\")";
      require_once 'includes/utilitarios.php';                                  $util= new Utilitario();
    ...
    public function alteraRedeSocial($cd_rede_social, $nm_rede_social, $ds_arquivo_logo_compartilhamento, $lk_rede_social, $eh_exibir, $eh_ativo, $lk_seo) {
