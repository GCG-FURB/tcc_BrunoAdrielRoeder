<?php
  class Pessoa {
    ...
    private function listarAcoes($secao, $subsecao, $item, $ativas, $categoria, $inicial) {
      ...
      echo "  <a href=\"index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&ct=".$categoria."&at=".$ativas."&in=".$inicial."&acao=atualizacao\"><img src=\"icones/atualizacao.png\" alt=\"Registrar pedido de atualização cadastral\" title=\"Registrar pedido de atualização cadastral\" border=\"0\"></a> \n";
      ...
      echo "  <a href=\"index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&ct=".$categoria."&at=".$ativas."&in=0\" class=\"fontLink\">A à Z</a>\n";
      echo "</p>\n";      
    }
    ...
    private function listarItens($secao, $subsecao, $item, $ativas, $categoria, $inicial) {
      ...
      foreach ($itens as $it) {
        ...
        if ($permissoes_usuario[34] == 1) {
          echo "        <a href=\"index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&ct=".$categoria."&in=".$inicial."&at=".$ativas."&cd=".$it['cd_pessoa']."&acao=permissoes\"><img src=\"icones/permissoes.png\" alt=\"Permissões do Usuário\" title=\"Permissões do Usuário\" border=\"0\"></a>\n";
        }
        if ($permissoes_usuario[32] == 1) {
...
/*
        echo "        <a href=\"index.php?secao=".$secao."&sub=25&it=".$item."&ca=".$it['cd_pessoa']."&cc=0\"><img src=\"icones/cursos_pessoas.png\" alt=\"Inscrições (Cursos x Pessoas)\" title=\"Inscrições (Cursos x Pessoas)\" border=\"0\"></a>\n";
*/
        echo "      </td>\n";
        echo "    </tr>\n";
      }
...
//*******************************PERMISSOES*************************************
    ...
    public function montarFormularioPermissoes($cd_pessoa, $link) {
      ...
      if ($permissoes_usuario[34] == 1) {
        ...
        echo "    <h2>Permissões do Usuário ".$pessoa['nm_pessoa']."</h2>\n";
...
//***************EXIBICAO PUBLICA***********************************************
    ...
    public function imprimeFormularioCadastroProprioPessoa($ds_username, $ds_senha, $nm_pessoa, $nr_cpf) {
      ...
      echo "              <input type=\"password\" maxlength=\"50\" class=\"fonInputExterno\" name=\"ds_confirma_senha\" id=\"ds_confirma_senha\" placeholder=\"Confirmação da senha\" alt=\"Confirme sua senha\" title=\"Confirme sua senha\" value=\"\" onKeyPress=\"ehValidar('1'); ehValido('eh_senha_valido', '0');\" onBlur=\"validaConfirmacaoSenha();\"><br />\n";
