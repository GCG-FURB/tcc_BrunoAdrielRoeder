<?php
  class SubAreaConhecimento {
    ...
    public function imprimeFormularioCadastro($link, $cd_sub_area_conhecimento, $cd_area_conhecimento, $nm_sub_area_conhecimento, $ds_sub_area_conhecimento, $eh_liberado, $cd_sub_area_conhecimento_destino, $eh_ativo) {
      ...
      $util->linhaUmCampoText(1, 'Sub Área do Conhecimento: ', 'nm_sub_area_conhecimento', '150', '100', $nm_sub_area_conhecimento);
    ...
    public function retornaCadastroSubAreasConhecimentoObjetoAprendizagem($cd_area_conhecimento, $tamanho, $cd_general) {
      ...
      $ajuda = "\n\nPara selecionar mais de um item, mantenha a tecla Ctrl pressionada e selecione os itens com um clic do mouse!\n".
               "Se a Sub Área de Conhecimento desejada não estiver cadastrada, informe no campo abaixo!\n".
               "Campo do Tipo Seletor\n";

      $retorno = "          <select name=\"cd_sub_area_conhecimento[]\" id=\"cd_sub_area_conhecimento\" alt=\"Sub Área do Conhecimento".$ajuda."\" title=\"Sub Área do Conhecimento".$ajuda."\" class=\"".$css."\" size=\"5\" multiple placeholder=\"Sub Área de Conhecimento\" tabindex=\"1\" style=\"height: 120px; width:".$tamanho."%;\" onFocus=\"alterarBorda(this,1)\" onBlur=\"alterarBorda(this,0)\">\n";
      foreach ($itens as $it) {
        $retorno.= "  			    <option ";
        foreach ($areas as $a) {
...
*/
      ...
      $retorno.= "          <input type=\"text\" maxlength=\"150\" name=\"ds_sub_area_conhecimento\" id=\"ds_sub_area_conhecimento\" value=\"\" style=\"width:".$tamanho."%;\" alt=\"Sub Área de Conhecimento - descritivo".$ajuda."\" title=\"Sub Área de Conhecimento - descritivo".$ajuda."\" class=\"".$css."\" placeholder=\"Sub Área de Conhecimento - descritivo\" tabindex=\"1\" onFocus=\"alterarBorda(this,1)\" onBlur=\"alterarBorda(this,0)\"/>\n";
/*
      $retorno.= "        <a href=\"#\" class=\"dcontexto\">\n";
      $retorno.= "          <img src=\"".$_SESSION['life_link_completo']."icones/help.png\"border=\"0\">\n";
      $retorno.= "          <span class=\"fontdDetalhar\">\n";
...
*/
    ...
    public function retornaCadastroSubAreasConhecimentoObjetoAprendizagemMultiplos($cd_area_conhecimento, $tamanho, $cd_general) {
      ...
      $retorno = "          <select name=\"cd_sub_area_conhecimento_".$cd_area_conhecimento."[]\" id=\"cd_sub_area_conhecimento_".$cd_area_conhecimento."\" alt=\"Sub Área do Conhecimento".$ajuda."\" title=\"Sub Área do Conhecimento".$ajuda."\" class=\"".$css."\" size=\"3\" multiple placeholder=\"Sub Área de Conhecimento\" tabindex=\"1\" style=\"height: 50px; width:".$tamanho."%;\" onFocus=\"alterarBorda(this,1)\" onBlur=\"alterarBorda(this,0)\">\n";
      foreach ($itens as $it) {
        $retorno.= "  			    <option ";
        foreach ($areas as $a) {
          if ($it['cd_sub_area_conhecimento'] == $a['cd_sub_area_conhecimento']) {          $retorno.= " selected ";        }
      ...
      $retorno.= "          <input type=\"text\" maxlength=\"150\" name=\"ds_sub_area_conhecimento_".$cd_area_conhecimento."\" id=\"ds_sub_area_conhecimento_".$cd_area_conhecimento."\" value=\"\" style=\"width:".$tamanho."%;\" alt=\"Sub Área de Conhecimento - descritivo".$ajuda."\" title=\"Sub Área de Conhecimento - descritivo".$ajuda."\" class=\"".$css."\" placeholder=\"Sub Área de Conhecimento - descritivo\" tabindex=\"1\" onFocus=\"alterarBorda(this,1)\" onBlur=\"alterarBorda(this,0)\"/>\n";
      return $retorno;
    }
