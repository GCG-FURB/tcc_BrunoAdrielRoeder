<?php
  class PedidoAlteracaoCategoria {
    ...
    private function listarAcoes($secao, $subsecao, $item, $ativas, $avaliadas, $voltar) {
      ...
      $opcoes= array();
      $opcao= array();      $opcao['indice']= "1";      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&at=1&av=".$avaliadas;                               $opcao['descricao']= "Ativos";                                        $opcoes[]= $opcao;
      $opcao= array();      $opcao['indice']= "2";      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&at=0&av=".$avaliadas;                               $opcao['descricao']= "Inativos";                                      $opcoes[]= $opcao;
      $opcao= array();      $opcao['indice']= "3";      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&at=2&av=".$avaliadas;                               $opcao['descricao']= "Ativos/Inativos";                               $opcoes[]= $opcao;
      $opcao= array();      $opcao['indice']= "4";      $opcao['link']= "";                                                                                                            $opcao['descricao']= "----------------------------------------";      $opcoes[]= $opcao;
      $opcao= array();      $opcao['indice']= "5";      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&at=".$ativas."&av=1";                               $opcao['descricao']= "Avaliados";                                     $opcoes[]= $opcao;
      $opcao= array();      $opcao['indice']= "6";      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&at=".$ativas."&av=0";                               $opcao['descricao']= "Pendentes";                                     $opcoes[]= $opcao;
      $opcao= array();      $opcao['indice']= "7";      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&at=".$ativas."&av=2";                               $opcao['descricao']= "Avaliados/Pendentes";                           $opcoes[]= $opcao;
...
//***************ALTERA CATEGORIA***********************************************
    ...
    public function retornaDadosCategoriaUsuario($link, $cd_usuario) {
      ...
      if ($conf->ehPossivelSolicitarAlteracaoCategoriaUsuario()) {
        ...
        echo "  <br />\n";
        echo "  <form method=\"POST\" name=\"cadastro\" action=\"".$_SESSION['life_link_completo'].$link."\">\n";
        echo "    <table class=\"tabConteudo\">\n";
        $util->campoHidden('trocar', '1');
        $util->linhaBotao('Solicitar troca de categoria de usuário');
        echo "    </table>\n";
        echo "  </form>\n";
      }
    }
    ...
    public function retornaFormularioAlteracaoCategoriaUsuario($link, $cd_usuario) {
      ...
      if ($conf->ehPossivelSolicitarAlteracaoCategoriaUsuario()) {
        ...
        if ($dados['eh_ficha_atualizada'] == '1') {
          ...
          echo "  <form method=\"POST\" name=\"cadastro\" action=\"".$_SESSION['life_link_completo'].$link."/registrar\" onSubmit=\"return valida(this);\">\n";
          ...
          echo "  	    <input type=\"submit\" class=\"celConteudoBotao\" value=\"Registre a solicitação\" tabindex=\"1\">\n";
          echo "      </td>\n";
          echo "  	</tr>\n";
          echo "  </table>\n";
        } else {
