<?php
  class Endereco {
    ...
    public function apresentaFormularioEndereco($titulo, $cd_endereco, $tem_campos_obrigatorios = true) {
      ...
      echo "          <input type=\"text\" maxlength=\"150\" name=\"ds_rua\" id=\"ds_rua\" value=\"".$ds_rua."\" size=\"45\" class=\"fontConteudoCampoTextHint\" style=\"width:80%;\"/>\n";
      echo "          Nº ".$simbolo." \n";
      echo "          <input type=\"text\" maxlength=\"10\" name=\"ds_numero\" id=\"ds_numero\" value=\"".$ds_numero."\" size=\"7\" class=\"fontConteudoCampoTextHint\" style=\"width:17%;\"/>\n";
      echo "        </td>\n";
      echo "      </tr>\n";    
      $util->linhaUmCampoText(0, 'Complemento: ', 'ds_complemento', 150, 100, $ds_complemento);
      $util->linhaUmCampoText($obrigatorios, 'Bairro: ', 'ds_bairro', 80, 100, $ds_bairro);
      $util->linhaUmCampoTextAcao($obrigatorios, 'CEP: ', 'ds_cep', 10, 100, $ds_cep, " onKeyPress=\"mascaraCep('ds_cep')\"; onBlur=\"validaCep('ds_cep');\" ");
      echo "  	<tr>\n";
      echo "  		<td class=\"celConteudo\">UF/Município: </td>\n";
      echo "  		<td class=\"celConteudo\">\n";
      if ($cd_cidade != "") {
        $cidade = $cid->selectDadosCidade($cd_cidade);
        $estado = $est->selectDadosEstado($cidade['cd_estado']);
...
//***************************BANCO DE DADOS*************************************
    ...
    public function selectEndereco($cd_endereco) {
      $sql  = "SELECT * ".
              "FROM life_enderecos ".
    ...
    public function selectEnderecoCompleto($codigo) {
      $sql  = "SELECT ed.*, cd.nm_cidade, es.sg_estado ".
              "FROM life_enderecos ed, life_cidades cd, life_estados es ".
