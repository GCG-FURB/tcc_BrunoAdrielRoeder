  ...
  class Permissao {
    ...
    public function retornaCamposPermissoes($ds_permissoes) {
      ...
      if (count($lista_permissoes_1) > 0) {
        $style= "linhaOn";
        echo "    <tr class=\"".$style."\">\n";
        echo "      <td class=\"celConteudo\" style=\"width:5%;\"></td>\n";
        echo "      <td class=\"celConteudo\" style=\"width:5%;\"></td>\n";
        echo "      <td class=\"celConteudo\" style=\"width:5%;\"></td>\n";
        ...
        foreach ($lista_permissoes_1 as $lp1) {
          ...
          echo "        <input type=\"checkbox\" name=\"pos_".$posicao_1."\" ";
          if ($permissao_1 == "1") {          echo " checked=\"true\" ";      } 
          echo "value=\"on\" class=\"celConteudo\">\n";
          echo "      </td>\n";
          echo "      <td class=\"celConteudo\" colspan=\"3\">".$acesso_1."</td>\n";
          echo "    </tr>\n";       
          ...
          foreach ($lista_permissoes_2 as $lp2) {
            ...
            echo "    <tr class=\"".$style."\">\n";
            echo "      <td class=\"celConteudo\" style=\"text-align:center;\"></td>\n";
            echo "      <td class=\"celConteudo\" style=\"text-align:center;\">\n";
            echo "        <input type=\"checkbox\" name=\"pos_".$posicao_2."\" ";
            if ($permissao_2 == "1") {          echo " checked=\"true\" ";      } 
            echo "value=\"on\" class=\"celConteudo\">\n";
            echo "      </td>\n";
            echo "      <td class=\"celConteudo\" colspan=\"2\">".$acesso_2."</td>\n";
            echo "    </tr>\n"; 

            $lista_permissoes_3= $this->selectListaPermissoes($lp2['cd_permissao']); 
            foreach ($lista_permissoes_3 as $lp3) {
              $style = ($style!="linhaOf")?('linhaOf'):('linhaOn');
              $posicao_3 = $lp3['nr_posicao'];
              $permissao_3 = $ds_permissoes[$posicao_3];
              $acesso_3 = $lp3['ds_permissao'];
          
              echo "    <tr class=\"".$style."\">\n";
              echo "      <td class=\"celConteudo\" style=\"text-align:center;\"></td>\n";
              echo "      <td class=\"celConteudo\" style=\"text-align:center;\"></td>\n";
              echo "      <td class=\"celConteudo\" style=\"text-align:center;\">\n";
              echo "        <input type=\"checkbox\" name=\"pos_".$posicao_3."\" ";
              if ($permissao_3 == "1") {          echo " checked=\"true\" ";      } 
              echo "value=\"on\" class=\"celConteudo\">\n";
              echo "      </td>\n";
              echo "      <td class=\"celConteudo\">".$acesso_3."</td>\n";
              echo "    </tr>\n";            
            }            
          }        
        }          
    ...
    public function retornaPermissoes() {
      ...
      $permissao =  $pos_0 .  $pos_1  . $pos_2  . $pos_3  . $pos_4  . $pos_5  . $pos_6  . $pos_7  . $pos_8  . $pos_9  . 
                    ...
                    $pos_90 . $pos_91 . $pos_92 . $pos_93 . $pos_94 . $pos_95 . $pos_96 . $pos_97 . $pos_98 . $pos_99;
