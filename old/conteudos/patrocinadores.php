<?php
  class Patrocinador {
    ...
    private function listarAcoes($secao, $subsecao, $item, $codigo_menu, $ativas) {
      ...
      $opcoes= array();
      $opcao= array();      $opcao['indice']= "1";      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&cdm=".$codigo_menu."&at=1";                 $opcao['descricao']= "Ativos";                                        $opcoes[]= $opcao;
      $opcao= array();      $opcao['indice']= "2";      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&cdm=".$codigo_menu."&at=0";                 $opcao['descricao']= "Inativos";                                      $opcoes[]= $opcao;
      $opcao= array();      $opcao['indice']= "3";      $opcao['link']= "index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&cdm=".$codigo_menu."&at=2";                 $opcao['descricao']= "Ativos/Inativos";                               $opcoes[]= $opcao;
    ...
    private function montarPatrocinadorEdicao($link, $cd_patrocinador) {
      ...
      echo "  <h2>Edição de Patrocinadores</h2>\n";
      $_SESSION['life_edicao']= 1;
      $this->imprimePatrocinadorCadastroPatrocinadores($link, $cd_patrocinador, $nm_patrocinador, $ds_link_patrocinador, $nr_ordem, $eh_ativo, $ds_logo);
    }
    ...
    private function imprimePatrocinadorCadastroPatrocinadores($link, $cd_patrocinador, $nm_patrocinador, $ds_link_patrocinador, $nr_ordem, $eh_ativo, $ds_logo) {
      ...
      if ($ds_logo != '') {
        ...
        $util->linhaComentario('Somente associe uma logo se desejar substituir a atual!');
      } else {
