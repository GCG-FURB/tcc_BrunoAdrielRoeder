  ...
  function atualizarCampoTipoArquivo($cd_formato, $cd_formato_antigo, $eh_setado, $ds_location) {
    ...
    switch ($cd_formato) {
      case "1":
        ...
        if ($eh_setado == '1') {   
          $ajuda .= "Para alterar o Link de arquivo de Áudio atual, informe novo link de Áudio!<br />";
        } else {
          $ajuda .= "Informe link de Áudio!<br />";
        }
      ...
      case "2":   
        ...
        if ($eh_setado == '1') {   
          $ajuda .= "Para alterar o Link de arquivo de Vídeo atual, informe novo link de Vídeo!<br />";
        } else {
          $ajuda .= "Informe link de Vídeo!<br />";
        }
      ...
      case "3":                     
        ...
        $ajuda .= "São aceitos arquivos nos formatos abaixo descritos, considerando limite de tamanho de cada arquivo em ".$ds_limite_tamanho_arquivos." MB.<br />".
      ...
      case "7":
        ...
        $ds_extensoes_arquivos = $arq_ext->retornaExtensoesArquivosObjetoAprendizagem($cd_formato);
        if ($eh_setado == '1') {
          $ajuda .= "Para alterar o arquivo de Apresentação, selecione novo Arquivo, ou deixe este campo em branco para manter o arquivo atual!<br />";
        } else {
          $ajuda .= "Selecione o arquivo de Apresentação!<br />";
        }
        $ajuda .= "São aceitos arquivos nos formatos abaixo descritos, considerando limite de tamanho de cada arquivo em ".$ds_limite_tamanho_arquivos." MB.<br />".
                  "Formatos: <br />".$ds_extensoes_arquivos."<br />".
                  "Este campo é de preenchimento obrigatório!<br />";
    ...
    $substituicao = "";
    if ($cd_formato == '') {
      $retorno.= "          <input type=\"text\" maxlength=\"0\" name=\"ds_technical_location\" id=\"ds_technical_location\" value=\"\" style=\"width:840px;\" alt=\"Localização do Arquivo contendo o Objeto de Aprendizagem\" title=\"Localização do Arquivo contendo o Objeto de Aprendizagem\" class=\"fontConteudoCampoTextHint\" placeholder=\"Localização\" tabindex=\"1\"/>\n";
    } elseif (($cd_formato == '1') || ($cd_formato == '2') || ($cd_formato == '6')) {
      $retorno.= "          <input type=\"text\" maxlength=\"250\" name=\"ds_technical_location\" id=\"ds_technical_location\" value=\"".$ds_location."\" style=\"width:840px;\" alt=\"Localização do Arquivo contendo o Objeto de Aprendizagem\" title=\"Localização do Arquivo contendo o Objeto de Aprendizagem\" class=\"fontConteudoCampoTextHintObrigatorio\" placeholder=\"Localização\" tabindex=\"1\"/>\n";
      ...
      $retorno.= "          <input type=\"file\" maxlength=\"150\" name=\"ds_technical_location\" id=\"ds_technical_location\" value=\"\" style=\"width:840px;\" alt=\"Localização do Arquivo contendo o Objeto de Aprendizagem\" title=\"Localização do Arquivo contendo o Objeto de Aprendizagem\" class=\"fontConteudoCampoTextHintObrigatorio\" placeholder=\"Localização\" tabindex=\"1\"/>\n";
