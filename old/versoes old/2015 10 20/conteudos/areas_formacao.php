<?php
  class AreaFormacao {
    ...
    public function imprimeFormularioCadastro($link, $cd_area_formacao, $nm_area_formacao, $ds_area_formacao, $eh_liberado, $cd_area_formacao_destino, $eh_ativo) {
      ...
      $util->linhaUmCampoText(1, 'Área de Formação: ', 'nm_area_formacao', '150', '70', $nm_area_formacao);
      $util->linhaTexto(0, 'Descrição: ', 'ds_area_formacao', $ds_area_formacao, '5', '965');
      ...
      if ($cd_area_formacao > 0) {        $util->linhaBotao('Editar');      } else {        $util->linhaBotao('Cadastrar');      }
      echo "    </table>\n";
...
//funcionalidade para ajustar todos os locais que usares area de formacao
    ...
    public function retornaSeletorOutrasAreasFormacao($cd_area_formacao) {
      ...
      $util->linhaSeletor('Áreas de Formação: ', 'cd_area_formacao_destino', $cd_area_formacao, $opcoes);      
    }      
