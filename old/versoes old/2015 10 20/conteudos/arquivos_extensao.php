<?php
  class ArquivoExtensao {
    ...
    private function imprimeFormularioCadastro($secao, $subsecao, $item, $ativas, $cd_arquivo_extensao, $nm_extensao, $ds_extensao, $eh_ativo, $cd_tipo_arquivo) {
      ...
      $util->linhaUmCampoTextHint(1, 'Descrição: ', 'nm_extensao', 150, 840, $nm_extensao, 1);
      $util->linhaUmCampoTextHint(1, 'Regra/Extensão: ', 'ds_extensao', 50, 840, $ds_extensao, 1);
      ...
      $util->linhaSeletorHint('Aplicação', 'cd_tipo_arquivo', $cd_tipo_arquivo, $opcoes, '840', '1', 1);
      $opcoes= array();
      ...
      if ($cd_arquivo_extensao > 0) {        $util->linhaBotao('Editar');      } else {        $util->linhaBotao('Cadastrar');      }
      echo "    </table>\n";
      echo "  </form>\n";       
    ...
    public function retornaExtensoesArquivosObjetoAprendizagem($cd_formato) {
      ...
      foreach ($extensoes as $e) {
        $retorno.= $e['nm_extensao']." [.".$e['ds_extensao']."]<br />";
      } 
      return $retorno;
    }
