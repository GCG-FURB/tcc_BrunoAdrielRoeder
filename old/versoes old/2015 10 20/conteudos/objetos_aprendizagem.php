    ...
    public function selectObjetosAprendizagem($eh_ativo, $ordem, $inicio, $limite) {
      ...
      foreach ($campos as $campo) {
        ...
        if ($campo['campo'] == 'coverage') {                                    //area de conhecimento
          ...
          if ($codigo > 0) {
            $sql.= "AND ( ".
                   "        ( oa.cd_general IN ( SELECT cd_general FROM life_general WHERE cd_coverage = '$codigo' ) ) ".
                   "    ) ";
          }
        }
        ...
        if ($campo['campo'] == 'type') {                                        //tipo
          $codigo = $campo['cd_campo'];
          if ($codigo > 0) {
            $sql.= "AND ( ".
                   "        ( oa.cd_technical IN ( SELECT cd_technical FROM life_technical WHERE cd_service IN ( SELECT cd_service FROM life_service WHERE cd_type  = '$codigo' ) ) ) ".
                   "    ) ";
          }
        }
      }
