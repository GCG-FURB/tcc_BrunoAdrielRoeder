<?php
  class StatusCicloVida {
    ...
    public function imprimeFormularioCadastro($link, $cd_status_ciclo_vida, $nm_status_ciclo_vida, $eh_ativo) {
      ...
      $util->linhaUmCampoText(1, 'Status do Ciclo de Vida: ', 'nm_status_ciclo_vida', '150', '70', $nm_status_ciclo_vida);
      ...
      if ($cd_status_ciclo_vida > 0) {        $util->linhaBotao('Editar');      } else {        $util->linhaBotao('Cadastrar');      }
      echo "    </table>\n";
    ...
    public function retornaSeletorStatusCicloVida($cd_status_ciclo_vida, $campo, $tamanho, $exibir_ajuda, $descricao) {
      require_once 'includes/utilitarios.php';                                  $util= new Utilitario();
      ...
      $util->linhaSeletorHint($descricao, $campo, $cd_status_ciclo_vida, $opcoes, $tamanho, false, $exibir_ajuda);
    }
    
    public function retornaDados($cd_status_ciclo_vida, $descricao) {
      $dados = $this->selectDadosStatusCicloVida($cd_status_ciclo_vida);
      
      return $descricao.': '.$dados['nm_status_ciclo_vida'].'<br />';
    } 

    public function retornaSeletorStatusCicloVidaFiltro($cd_status_ciclo_vida, $nome, $tamanho, $exibir_ajuda, $descricao) {
      require_once 'includes/utilitarios.php';                                  $util= new Utilitario();
      ...
      if ($exibir_ajuda == '1') {
        ...
        echo "          <span class=\"fontdDetalhar\">\n";
        echo "            Para utilizar o Filtro por Status, selecione o Status desejado\n";
        echo "          </span>\n";
        echo "        </a>\n";
      } else {
