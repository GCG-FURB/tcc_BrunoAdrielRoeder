<?php
  class AreaFormacao {
    ...
    public function listarAcoes($secao, $subsecao, $item, $ativas, $liberadas) {
      ...
      echo "  <a href=\"index.php?secao=".$secao."&sub=".$subsecao."&it=".$item."&li=".$liberadsa."&at=".$ativas."&acao=cadastrar\"><img src=\"icones/novo.png\" alt=\"Nova Área de Formação\" title=\"Nova Área de Formação\" border=\"0\"></a> \n";
