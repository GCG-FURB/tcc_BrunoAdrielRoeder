<?php
  class Linguagem {
    ...
    public function imprimeFormularioCadastro($link, $cd_linguagem, $nm_linguagem, $eh_ativo) {
      ...
      $util->linhaUmCampoText(1, 'Idioma: ', 'nm_linguagem', '150', '70', $nm_linguagem);
      ...
      if ($cd_linguagem > 0) {        $util->linhaBotao('Editar');      } else {        $util->linhaBotao('Cadastrar');      }
      echo "    </table>\n";
    ...
    public function retornaSeletorLinguagem($cd_linguagem, $campo, $tamanho, $exibir_ajuda, $descricao) {
      require_once 'includes/utilitarios.php';                                  $util= new Utilitario();
      ...
      $util->linhaSeletorHint($descricao, $campo, $cd_linguagem, $opcoes, $tamanho, false, $exibir_ajuda);
    }
    
    public function retornaDados($cd_linguagem, $descricao) {
      $dados = $this->selectDadosLinguagem($cd_linguagem);
      
      return $descricao.': '.$dados['nm_linguagem'].'<br />';
    } 

    public function retornaSeletorLinguagemFiltro($cd_linguagem, $nome, $tamanho, $exibir_ajuda, $descricao) {
      require_once 'includes/utilitarios.php';                                  $util= new Utilitario();
      ...
      if ($exibir_ajuda == '1') {
        ...
        echo "          <span class=\"fontdDetalhar\">\n";
        echo "            Para utilizar o Filtro por Idioma, selecione o Idioma desejado\n";
        echo "          </span>\n";
        echo "        </a>\n";
      } else {
