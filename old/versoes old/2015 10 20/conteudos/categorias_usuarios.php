<?php
  class CategoriaUsuario {
    ...
    private function montarFormularioEdicao($link, $cd_categoria_usuario) {
      ...
      $this->imprimeFormularioCadastro($link, $cd_categoria_usuario, $nm_categoria_usuario, $eh_liberacao_automatica, $ds_permissoes_padrao, $eh_ativo, $eh_permitido_cadastro, $cd_categoria_usuario_liberacao);
    }
    
    public function imprimeFormularioCadastro($link, $cd_categoria_usuario, $nm_categoria_usuario, $eh_liberacao_automatica, $ds_permissoes_padrao, $eh_ativo, $eh_permitido_cadastro, $cd_categoria_usuario_liberacao) {
      require_once 'includes/utilitarios.php';                                  $util = new Utilitario();
      ...
      $util->linhaSeletor('Liberação de Novos Usuários deve ser automática: ', 'eh_liberacao_automatica', $eh_liberacao_automatica, $opcoes);
      ...
      $util->linhaSeletor('É permitido que usuários não logados se cadastrem nesta categoria: ', 'eh_permitido_cadastro', $eh_permitido_cadastro, $opcoes);
    ...
    public function salvarCadastroAlteracao() {
      ...
      if ($this->alteraCategoriaUsuario($cd_categoria_usuario, $nm_categoria_usuario, $eh_liberacao_automatica, $ds_permissoes_padrao, $eh_ativo, $eh_permitido_cadastro, $cd_categoria_usuario_liberacao)) {
    ...
    public function retornaSeletorCategoriasUsuarios($cd_categoria_usuario, $campo) {
      ...
      $util->linhaSeletor('Categoria de Usuário: ', $campo, $cd_categoria_usuario, $opcoes);      
    }   
...
//**************BANCO DE DADOS**************************************************    
    ...
    public function alteraCategoriaUsuario($cd_categoria_usuario, $nm_categoria_usuario, $eh_liberacao_automatica, $ds_permissoes_padrao, $eh_ativo, $eh_permitido_cadastro, $cd_categoria_usuario_liberacao) {
