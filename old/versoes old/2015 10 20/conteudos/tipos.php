<?php
  class Tipo {
    ...
    public function imprimeFormularioCadastro($link, $cd_tipo, $nm_tipo, $eh_ativo) {
      ...
      $util->linhaUmCampoText(1, 'Tipo: ', 'nm_tipo', '150', '70', $nm_tipo);
      ...
      if ($cd_tipo > 0) {        $util->linhaBotao('Editar');      } else {        $util->linhaBotao('Cadastrar');      }
      echo "    </table>\n";
    ...
    public function retornaSeletorTipo($cd_tipo, $campo, $tamanho, $exibir_ajuda, $descricao) {
      require_once 'includes/utilitarios.php';                                  $util= new Utilitario();
      ...
      $util->linhaSeletorHint($descricao, $campo, $cd_tipo, $opcoes, $tamanho, false, $exibir_ajuda);
    }
    
    public function retornaDados($cd_tipo, $descricao) {
      $dados = $this->selectDadosTipo($cd_tipo);
      
      return $descricao.': '.$dados['nm_tipo'];
    } 
