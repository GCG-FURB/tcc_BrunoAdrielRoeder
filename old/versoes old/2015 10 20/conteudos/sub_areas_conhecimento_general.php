<?php
  class SubAreaConhecimentoGeneral {
    ...
    public function salvarSubAreasConhecimentoGeneral($cd_general, $cd_coverage) {
      require_once 'conteudos/sub_areas_conhecimento.php';                      $sac = new SubAreaConhecimento();
      $this->alteraStatusSubAreaConhecimentoGeneral('', $cd_general, '0');
      
      $erros = false;
      if (isset($_POST['cd_sub_area_conhecimento'])) {
        $sub_areas_conhecimento = $_POST['cd_sub_area_conhecimento'];
      ...
      $ds_sub_area_conhecimento = addslashes($_POST['ds_sub_area_conhecimento']);
      if ($ds_sub_area_conhecimento != '') {
        $cd_sub_area_conhecimento = $sac->estaCadastrado($ds_sub_area_conhecimento, $cd_coverage);
    ...
    public function retornaDados($cd_area_conhecimento, $cd_general) {
      ...
      if (count($itens) > 0) {
        $retorno = 'Sub Áreas de Conhecimento: ';
        if (count($itens) == 1) {
          $it = $itens[0];
    ...
    public function retornaRelacaoSubAreasConhecimentoGeneralAreasConhecimento($cd_area_conhecimento, $cd_general) {
      $itens = $this->selectSubAreasConhecimentoGeneralAreasConhecimento($cd_area_conhecimento, $cd_general, '1');
