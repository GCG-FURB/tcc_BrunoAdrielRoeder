<?php
  //classe para trabalhar as questoes referentes a data e hora
  class DataHora {
    ...
    public function imprimeFormularioData($data, $sufixo) {
      $dia= date('j', strtotime($data));
      $mes= date('n', strtotime($data));
      $ano= date('Y', strtotime($data));
          
      $saida  = "<select id=\"dia_".$sufixo."\" name=\"dia_".$sufixo."\" class=\"fontConteudo\">\n";
      for ($i=1; $i<=31; $i++) {
