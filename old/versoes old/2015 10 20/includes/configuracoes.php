<?php
  class Configuracao {
    ...
    private function montarFormularioConfiguracaoDescricaoCamposObba() {
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações Gerais do Objeto Educacional');
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações sobre Ciclo de Vida do Objeto Educacional');
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações de Meta-Metadata sobre o Objeto Educacional');
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações Técnicas sobre o Objeto Educacional');
      ...
      $this->tiluloSecao('Configurações de Informações Técnicas sobre o Objeto Educacional referentes à Plataformas e Características Específicas');
      ...
      $util->linhaComentario('<br />');
      $this->tiluloSecao('Configurações de Informações Técnicas sobre o Objeto Educacional referentes à Serviços');
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações Educacionais sobre o Objeto Educacional');
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações de Direitos  sobre o Objeto Educacional');
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações sobre Relações do Objeto Educacional');
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações de Anotações sobre o Objeto Educacional');
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações sobre Classificações do Objeto Educacional');
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações sobre Acessibilidade para o Objeto Educacional');
      ...
      $util->linhaComentario('<hr>');
      $this->tiluloSecao('Configurações de Informações por Segmento sobre o Objeto Educacional');
    ...
    private function montarFormularioConfiguracaoCamposPadraoObba() {
      ...
      $this->tiluloSecao('Configurações de Campos de Cadastro do Padrão OBBA');
...
//************************DESCRICAO*CAMPOS*OBBA*********************************
    ...
    public function retornaDescricaoCampoAcessibilityElementosTáteis() {
