...
class Login
{
    ...
    public function imprimeFormularioLogin()
    {
        ...
        if (!isset($_SESSION['life_bloqueio_login'])) {
            $_SESSION['life_bloqueio_login'] = '0';
        }
        ...
        echo "        E-mail<br />\n";
        echo "        <input type=\"text\" maxlength=\"100\" name=\"usuario\" id=\"usuario\" class=\"fontConteudoCampoTextHint\" style=\"width:100%;\" title=\"Informe o seu E-mail\" />\n";
        echo "      </p>\n";
        echo "      <p class=\"fontConteudoLogin\">\n";
        echo "        Senha<br />\n";
        echo "        <input type=\"password\" maxlength=\"50\" name=\"senha\" id=\"senha\" size=\"40\" class=\"fontConteudoCampoTextHint\" style=\"width:100%;\" title=\"Informe sua Senha\" />\n";
        echo "      </p>\n";
        echo "      <p class=\"fontConteudoLogin\">\n";
        if ($_SESSION['life_bloqueio_login'] == '1') {
            ...
            echo "  		  <input type=\"submit\" class=\"botao\" value=\"Entre\" title=\"Efetuar Login\" onClick=\"desmarcarDigitou();document.getElementById('login').submit();\">\n";
            echo "        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n";
