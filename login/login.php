<?php 
  class Login {
    ...
    public function imprimeFormularioLogin() {
      ...
      echo "  <p style=\"width:97%; text-align:right;\"><a href=\"javascript:;\" onClick=\"ocultarLogin(event);\" onKeyPress=\"ocultarLogin(event);\"><img src=\"".$_SESSION['life_link_completo']."icones/fechar_formulario.png\" alt=\"Fechar tela de login\" title=\"Fechar tela de login\" border=\"0\" onMouseOver=\"this.style.cursor='pointer';\"></a></p>\n";
